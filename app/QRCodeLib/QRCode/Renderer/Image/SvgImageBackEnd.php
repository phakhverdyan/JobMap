...
final class SvgImageBackEnd implements ImageBackEndInterface
{
    ...
    private function drawLogoImage(){
        ...
        $this->xmlWriter->writeAttribute('xlink:href', $this->logoImage->getData());
        $this->xmlWriter->writeAttribute('height', $this->logoImage->getHeight()."px");
        $this->xmlWriter->writeAttribute('width', $this->logoImage->getWidth()."px");
        $this->xmlWriter->writeAttribute('x', $this->logoImage->getPositionX());
        $this->xmlWriter->writeAttribute('y', $this->logoImage->getPositionY());
        $this->xmlWriter->endElement();
    }
