...
<div class="main-wrapper" style="max-width: 100%;">
    <div class="container" style="width: 1024px; margin:0 auto; border:1px solid #000; padding: 10px 10px;">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="width: 50%;">
                    ...
                    <p style="margin-bottom: 0;">GST Registration #{{ $tax->gst_number }}</p>
                    <p style="margin-top:0;">QST Registration #{{ $tax->qst_number }}</p>
                </td>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="text-align: center; vertical-align: top; width: 50%;">
                    ...
                    <p>Please see <a href="https://jobmap.co/pricing">jobmap.co/pricing</a></p>
                    <p style="margin-top: 120px;"><span>Phone</span></p>
                </td>
            </tr>
            </tbody>
        </table>
            ...
            <tr>
                <td>
                    ...
                    <p>
                        ...
                        <a href="https://jobmap.co/terms">jobmap.co/terms</a>
                    </p>
                    <p>Questions regarding this receipt? Contact us at: 1-877-181-1919 or by email at
                        billing@jobmap.co</p>
                </td>
            </tr>
            </tbody>
            ...
            @if($invoice->coupon_id > 0)
                <tr style="text-align: center;">
                    ...
                    @else
                        ...
                        @endphp
                        <td style="padding:10px;border: 1px solid #000;">Discount code
                            (<strong>{{ $payment_info['discount']['code'] }}</strong>)</td>
                        <td style="padding:10px;border: 1px solid #000;">1</td>
                        <td style="padding:10px;border: 1px solid #000;">
        ...
        @if ($billingAddress->country_code === 'CA')
