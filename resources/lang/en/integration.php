...
return [
    'title' => "Which hiring channel do you wish to make <strong>unexpirable</strong> ?",
    ...
    'header' => [
        ...
        'complete_percent' => 'Your integration is <strong id="progress-percent"></strong> complete',
    ],
    ...
    'tabs' => [
        'website' => "<span class=\"part_rb\">Website</span>&nbsp;Button</span>",
        'import' => "Import",
        'cr_email' => "CR Email",
        'email_fr' => "<span class=\"part_rb\">Email</span>&nbsp;Forwarder",
        'scan' => "<span class=\"part_rb\">Resume</span>&nbsp;Scanner",
        'career' => "<span class=\"part_rb\">Link to </span>&nbsp;Career&nbsp;<span class=\"part_rb\">Page</span>",
        'boards' => "<span class=\"part_rb\">Job</span>&nbsp;Boards",
        'social' => "<span class=\"part_rb\">Social</span>&nbsp;Media",
        'posting' => "<span class=\"part_rb\">Free Job</span>&nbsp;Posting",
    ],
    
    'website' => [
        'title' => "Gather unexpirable candidates straight from your website by adding a direct link to your JobMap Career Page.",
        'time' => "2 min",
        'link_1' => "Create your custom button",
        'link_2' => "Paste the code",
        'link_3' => "Receive the unexpirable candidates",
        'text_box_1' => [
           'title' => "How it works",
           'text' => "Visitors come to your website and click on your button to instantly see your JobMap career page where they apply and see all of your open and closed job posts."
        ],
        'hint' => "<p class=\"text-center\">
                				This section might require you to contact your  IT /  website administrator in order to copy paste the code, which takes <strong>less than 10 seconds</strong> to do.
                			</p>
                			<p class=\"text-center mb-0\">Simply let them know the exact location on the page where you want this button.</p>",
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>Go to your button page from the left menu <a href=\"/business/button/manager\" class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</a></li>
		                	<li class=\"mt-3\">Choose colors, texts, spaces , borders to make it look like your website</li>
		                	<li class=\"mt-3\">Save the button, this will generate the button Code</li>
		                	<li class=\"mt-3\">Paste it anywhere on the HTML part of the website where you wish for it to appear</li>
		                	<li class=\"mt-3\"><img src=\":image\" style=\"margin-top: -3px;\" class=\"mr-3\"><strong>Enjoy unexpirable candiates</strong></li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">Put it on your main page, footer or header...</li>
                	<li class=\"mt-2\">If you have a career page, add it to a visible space</li>"
        ]
    ],
    
    'import' => [
        'title' => "Instantly turn your static applicants into always up-to-date unexpirable candidates",
        'time' => "5 min",
        'link_1' => "Export into an excel/csv file",
        'link_2' => "Upload into JobMap",
        'link_3' => "If applicants reply, they all become unexpirable",
        'text_box_1' => [
          'title' => "How it works",
          'text' => "If you are already using an ATS or store your applicants in an excel list, simply upload them into the ATS section."
        ],
        'hint' => "You can easily google the steps to export candidates from your ATS system.",
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>From ATS , export candidates into an excel sheet or have your excel/csv sheet ready</li>
		                	<li class=\"mt-3\">Go to your <strong>ATS page</strong> from the left menu. <button class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</button></li>
		                	<li class=\"mt-3\">Click the upload button</li>
		                	<li class=\"mt-3\"><img src=\":image\" style=\"margin-top: -3px;\" class=\"mr-3\"><strong>This will notify your candidates instantly</strong></li>
                            <li class=\"mt-3\">The interested applicants will appear in your Applicant pipeline under \"ATS\".</li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">When you export, the only needed column is email, the rest you can ignore it.</li>"
        ]
    ],
    ...
    'cr_email' => [
        ...
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>Get your JobMap email from the CR EMail section on the left menu<button class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</button></li>
		                	...
		                	<li class=\"mt-3\"><img src=\":image\" style=\"margin-top: -3px;\" class=\"mr-3\"><strong>Candidates will create unexpirable JobMap instead of sending you static CVs</strong></li>
    ...
    'scan' => [
        'title' => "Make your in-store paper resumes unexpirable",
        'time' => "1 minute from install to first scan",
        'link_1' => "Get the JobMap App",
        'link_2' => "Login as a business",
        'link_3' => "Place device over the resume",
        'link_4' => "They become unexpirable",
        'text_box_1' => [
            'title' => "How its works",
            'text' => "When applicants hand over a paper resume, any manager can use the app to scan the paper. This invites the applicant to create a JobMap"
        ],
        'hint' => "Retain all candidates that you receive through your email.",
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>Go to the Google playstore or the iPhone App Store</li>
        ...
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">Ask your branch/store managers to scan resumes - this will render them unexpirable</li>"
        ]
    ],
    
    'career' => [
        'title' => "Link to your career page",
        'time' => "1 minute",
        'link_1' => "Copy the link",
        'link_2' => "Add it anywhere",
        'link_3' => "Gather unexpirable candidates",
        'text_box_1' => [
            'title' => "How its works",
            'text' => "By adding the link to your job posts, websites, social posts you will receive only unexpirable applicants."
        ],
      'hint' => "Sometimes this Requires your website/IT admin",
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>From the Career page link on the left, select the link , and copy it where needed.<button class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</button></li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">Ask your branch/store managers to scan resumes - this will render them unexpirable</li>"
    ...
    'boards' => [
        'title' => "<p class=\"mb-1 text text-center fw-lighter\" style=\"font-size:30px;\">Get extreme ROI while posting on job boards</p>
                <p class=\"mb-5 text text-center fw-lighter\" style=\"font-size:30px;\">Works with 200+ popular job board websites</p>",
        'time' => "1 minute",
        'link_1' => "Copy the link",
        'link_2' => "Add it anywhere on the job post",
        'link_3' => "Gather unexpirable candidates",
        'text_box_1' => [
          'title' => "How it works",
            'text' => "By adding a CR Job board link, you will forever keep the candidates that will see your posts on job boards. This greatly improves the ROI of each job posting."
        ],
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>From the Job Boards link on the left, select the link , and copy it where needed.<button class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</button></li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
          'text' => "<li class=\"mt-2\">Adding the link to the top or bottom of your job post and directing your applicants to apply there will render them unexpirable.</li>"
        ]
    ],
    
    'social' => [
        'title' => "<p class=\"mb-1 text text-center fw-lighter\" style=\"font-size:30px;\">Social posting</p>
                <p class=\"mb-5 text text-center fw-lighter\" style=\"font-size:30px;\">CR Link</p>",
        'time' => "Less than a minute",
        'link_1' => "Copy the link",
        'link_2' => "Add it to any social post",
        'link_3' => "Gather unexpirable candidates",
        'text_box_1' => [
          'title' => "How it works",
          'text' => "By adding a CR link to your social media posts, all of the applicants will become unexpirable."
        ],
        'text_box_2' => [
            'title' => "Steps to integrate",
            'text' => "<li>From the Social Posts menu, copy the CR link and paste it to a social network post<button class=\"btn btn-primary btn-sm ml-3 mxa-0\">:button</button></li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">Adding the link to your job post on social media will render applicants unexpirable.</li>"
        ]
    ],
    
    'posting' => [
        'title' => "<p class=\"mb-1 text text-center fw-lighter\" style=\"font-size:30px;\">Unlimited <span style=\"font-size: 50px;\">Free</span> Job Posting on JobMap</p>
                <p class=\"mb-5 text text-center fw-lighter\" style=\"font-size:30px;\">Use our geolocation tool to attract local talent</p>",
        'time' => "Depends on your hiring needs",
        'link_1' => "Add locations",
        'link_2' => "Add jobs",
        'link_3' => "Gather unexpirable candidates",
        'hint' => "On our free plan, you can renew an unlimited amount of jobs manually.<br>
								Upgrade to any plan for the job auto-renew function to be active.",
        'text_box_1' => [
          'title' => "How it works",
          'text' => "JobMap geolocalizes your branches/employer locations. Nearby candidates can see the available jobs within each location and find your business on the JobMap search engine."
        ],
        'text_box_2' => [
            'title' => "Steps to integrate",
          'text' => "<li>Create your first location even if you have multiple ones<button class=\"btn btn-primary btn-sm ml-3\">:button</button></li>
		                	<li class=\"mt-3\">Create your jobs and assign them to locations<button class=\"btn btn-primary btn-sm ml-3\">:button</button></li>"
        ],
        'text_box_3' => [
            'title' => "Best practices",
            'text' => "<li class=\"mt-2\">It is absolutely free to add unlimited job positions on JobMap</li>
                	<li class=\"mt-2\">Remember even if no jobs are available, you can still receive candidates.</li>
                	<li class=\"mt-2\">Adding all of your available jobs, even if closed will increase your chances of getting candidates</li>
              	<li class=\"mt-2\">Adding all of your branch locations increases your chances of receiving local candidates around specific locations.</li>
                	<li class=\"mt-2\">Be sure to have the right logo for your business so that your company appears correctly on JobMap</li>"
        ]
    ],
