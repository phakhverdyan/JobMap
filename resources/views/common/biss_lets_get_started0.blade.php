...
<body>
    <div class="container" style="margin-top: 60px;">
        <div class="col-12">
            ...
            <p class="text-center mb-3" style="font-size: 30px;">Here's how CloudResume will help you</p>
            <p class="text-center mb-5" style="font-size: 25px;">You receive applicants from any of these channels</p>
            <div class="d-flex justify-content-center flex-column-reverse flex-lg-row mb-5">
                <div class="col-12 px-0">
                    ...
                    <div class="text-center">
                        ...
                        Expirable Applicants
                    </div>
                </div>
            </div>
            <p class="text-center mb-4" style="font-size: 20px;">We make these candidates never-expiring, always updated in real time and reachable via instant messenger</p>
            <p class="mb-3">
                <a href="{!! url('/lets-get-started1') !!}" class="btn btn-primary btn-block col-lg-5 col-10 mx-auto" role="button">Got it</a>
            </p>
        </div>
    </div>
