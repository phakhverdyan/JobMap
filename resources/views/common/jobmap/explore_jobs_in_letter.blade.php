            ...
            <div class="container py-5">
                <div class="col-12">
                    <p class="title_left_sorting d-flex animated fadeInDown" style="font-size: 24px;">
                        ...
                        <strong>{!! trans('main.explore_jobs_in', ['item' => $current]) !!}</strong>
                        <span class="ml-auto">
                    ...
                    <div class="col-12 px-0" style="margin-top: 70px;">
                        <p class="title_left_sorting">
                            <strong>{!! trans('main.label.all_job_categories_in', ['item' => $current]) !!}</strong>
                        </p>
                        <?php
                        $i = 0;
                        $j = 0;
                        foreach ($subCategoriesByLetter as $l) {
                        ++$j;
                        if ($i == 0) {
                        ?>
