...
@section('content')
    ...
    <div class="container-fluid px-0 mt-3 user-landing" style="overflow: hidden;">

        <div class="col-md-12 px-0" id="job-map" style="height: 600px;"></div>
        ...
        <form action="/search/{{ $type_items }}?{!! urldecode(request()->getQueryString()) !!}" id="search-form" autocomplete="off">
            <div class="row">
                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="col-12 col-lg-5 px-0 pxa-0" id="title-box">
                                    <label class="text-left"
                                           style="color:#555;">{!! trans('fields.label.job_title_or_company') !!}</label>
                                    <div class="form-control bg-white rounded-0 d-flex border"
                                        ...
                                        <input type="text" name="title" autocomplete="off"
                                               placeholder="{!! trans('fields.placeholder.job_title_or_company') !!}"
                                ...
                                <div class="col-12 col-lg-5 px-0 pxa-0" id="location-box">
                                    <label class="text-left"
                                           style="color:#555;">{!! trans('fields.label.location') !!}</label>
                                    <div class="form-control bg-white rounded-0 d-flex border"
                                         style="box-shadow: inset 0 1px 1px rgba(0,0,0,0.075);">
                                        <p class="my-0 mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="col-12 col-lg-2 px-0 pxa-0" id="button-box">
                                    <label class="text-right back_to_cardinal" style="position: absolute; top:0; right: 15px; white-space: nowrap;">
                                        <a href="/" class="cardinal_links mr-3">Simple</a>
                    ...
                    <div class="col-12 mx-auto px-0">
                                ...
                                <!-- ONE CATEGORY START -->
                                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                                        ...
                                        <a href="#" class="open_close_category cardinal_links">
                                            <span class="title_left_sorting"><strong>{!! trans('fields.label.keywords') !!}</strong></span>
                                    ...
                                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                                        ...
                                        <div class="content_category">
                                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                                <?php
                                                $posted = ['24 hours', '7 days', '15 days', '30 days'];
                                                ...
                                                <li><a href="javascript:void(0)"
                                                       class="cardinal_links remove-all-filter"
                                                       data-filter="posted">{!! trans('main.buttons.all') !!}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- ONE CATEGORY END -->
                        ...
                        'count' => ($items->count) ?? 0
                                    ...
                                    <div class="ml-auto d-flex flex-column-reverse flex-lg-row mxa-0">
                                        {{--<a href="/search/jobs?{!! urldecode(request()->getQueryString()) !!}"--}}
                                        <a href="/search/jobs"
                                           class="cardinal_links pt-2"
                                           @if($type_items == 'jobs') style="font-weight: bold" @endif>{!! trans('main.jobs') !!}</a>
                                        {{--<a href="/search/employers?{!! urldecode(request()->getQueryString()) !!}"--}}
                                        <a href="/search/employers"
                                           class="cardinal_links ml-3 mxa-0 pt-2"
                                           @if($type_items == 'employers') style="font-weight: bold" @endif>{!! trans('main.employers') !!}</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header pt-0">
                    <h5 class="modal-title">{!! trans('modals.title.share_this_job') !!}</h5>
                ...
                <div class="modal-body pb-2">
                    <p>
                        <strong>{!! trans('modals.text.share_1') !!}</strong>
                    </p>
                    <p>
                    <div class="btn-group w-100" role="group" aria-label="Basic example">
                        <input class="form-control text-center" type="text" name="sharelink"
                               value="{{ url('/') }}/l/434343" readonly>
                        <button class="btn btn-outline-primary">{!! trans('main.buttons.copy') !!}</button>
                    </div>
                    </p>
                    <p>
                        <strong>{!! trans('modals.text.share_2') !!}</strong>
                    </p>
                    <p>
                    <div class="btn-group w-100" role="group" aria-label="Basic example">
                        <input class="form-control" type="text" name="sharelink" placeholder="{!! trans('fields.placeholder.email') !!}" autocomplete="off">
                        <button class="btn btn-primary">{!! trans('main.buttons.send') !!}</button>
                    </div>
                    </p>
                    <p class="mt-3">
                        <strong>{!! trans('modals.text.share_3') !!}</strong>
                    </p>
                    <ul style="list-style: none; display: inline-flex;" class="pl-0">
                        <li class="pr-3"><a href="#"><img src="{{ asset('img/social/linkedin.png') }}" alt=""
                                                          height="50"/></a></li>
                        <li class="pr-3"><a href="#"><img src="{{ asset('img/social/facebook.png') }}" alt=""
                                                          height="50"/></a></li>
                        <li class="pr-3"><a href="#"><img src="{{ asset('img/social/google.png') }}" alt=""
                                                          height="50"/></a></li>
                        <li class="pr-3"><a href="#"><img src="{{ asset('img/social/twitter.png') }}" alt=""
                                                          height="50"/></a></li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-success btn-block" id="modal-items-accept">{!! trans('main.buttons.accept') !!}
                                    </button>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        /*$(document).ready(function () {
            Loader.init();
            var S = new Search('search', '{{ $type_items }}');
            S.setAssignLocations({!! json_encode($items) !!});
            app.scripts(S.init());
            app.run();
        });*/
    </script>
