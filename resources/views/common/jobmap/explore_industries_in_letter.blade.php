            ...
            <div class="container py-5">
                <div class="col-12">
                    <p class="title_left_sorting d-flex animated fadeInDown" style="font-size: 24px;">
                        ...
                        <strong>{!! trans('main.explore_industries_in', ['item' => $current]) !!}</strong>
                        <span class="ml-auto">
                        <a href="{!! url('/explore-industries') !!}" class="btn btn-outline-primary seeall_btn"
                           role="button">{!! trans('main.buttons.back_to_all_industries') !!}</a>
                    </span>
                    </p>
                    ...
                    <div class="col-12 px-0" style="margin-top: 70px;">
                        <p class="title_left_sorting">
                            <strong>{!! trans('main.label.all_industries_in', ['item' => $current]) !!}</strong>
                        </p>
                        <?php
                        $i = 0;
                        $j = 0;
