    ...
    <div id="location-view" style="margin-top: 55px;">
        ...
        <div class="text-center py-4" style="background-color: rgba(0,0,0,0.6); position: absolute; width: 100%; z-index: 1;">
            <p class="text-center mb-0">
                ...
                <a href="/map/address/{{ $number . '+' . $street }}/{{ $city }}/{{ $country }}"
                   id="link-location-address" class="text-white" data-toggle="tooltip"
                   data-placement="top"
                   title="{!! trans('main.explore_address') !!}">{{ $street . ' ' . $number }}</a>
            </p>
        </div>
