            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-11 col-xl-10 text-center my-5 pb-5">
                    ...
                    <p class="title_left_sorting d-flex animated fadeInDown" style="font-size: 24px;">
                        ...
                        <strong>{!! trans('main.explore_world') !!}</strong>
                    </p>

                    <div class="card border-0 mb-4 mb-sm-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-11">
                                    <div class="col-12">
                                        ...
                                        if ($i == 0) {
                                        ?>
                                        <div class="row @if($j != 1) mt-1 @endif">
                                            <?php
                                            }
                                            ?>
                                            <div class="col-6 col-lg-2">
                                                <span><i class="glyphicon bfh-flag-{!! $l['country_code'] !!}"></i></span>
                                                <a href="/map/country/{{ $l['country'] }}"
                                                   class="breadcrumb_custom">{{ $l['country'] }}</a>
                                            </div>
                                            <?php
                                            ++$i;
                                            if ($i == 6 || ($i != 6 && $j == count($locations))) {
                                            $i = 0;
                                            ?>
                                        </div>
                                        <?php
                    ...
                    @include('common.jobmap.job.job_map_world_item')
...
@section('script')
    ...
    <script src="{{ asset('/js/jobmap/app/world.js?v='.time()) }}"></script>
    <script>
        $(document).ready(function () {
            Loader.init();
            var View = new World('{{ $type_items }}');
