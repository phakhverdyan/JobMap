            ...
            <div class="container py-5">
                <div class="col-12">
                    ...
                    <g>
                        ...
                        <strong>{!! trans('main.explore_employers_in', ['item' => $current]) !!}</strong>
                        <span class="ml-auto">
                        <a href="{!! url('/explore-employers') !!}" class="btn btn-outline-primary seeall_btn"
                           role="button">{!! trans('main.buttons.back_to_all_employers') !!}</a>
                    </span>
                    </p>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <p>
                            @foreach($letters as $letter)
                                <a href="{!! url('/explore-employers-in-letter') !!}/{!! $letter !!}"
                    ...
                    <div class="col-12 px-0" style="margin-top: 70px;">
                        <p class="title_left_sorting">
                            <strong>{!! trans('main.label.explore_employers_in', ['item' => $current]) !!}</strong>
                        </p>
                        <div class="row">
                            <?php
                            $i = 0;
                            $j = 0;
                            foreach ($businessByLetter as $l) {
                            ++$j;
                            if ($i == 0) {
                            ?>
                            <div class="col-lg-3 col-12 col-md-6">
                                ...
                                ?>
                                <p>
                                    <a href="{!! url('/') . '/business/view/' . $l['id'] . '/' . $l['slug'] !!}"
                                       class="cardinal_links" style="font-size: 17px;" target="_blank">
                                        <img class="mr-2" alt="{{ $l['name'] }}"
                                             style="width: 20px; height: 20px; border-radius: .25rem; margin-top: -3px;"
                                             src="{!! businessPicture($l) !!}">
                                        {{ $l['name'] }}
                                    </a>
                                </p>
                                <?php
                                ++$i;
                                if ($i == 2 || ($i != 2 && $j == count($businessByLetter))) {
                                $i = 0;
                                ?>
                            </div>
                            <?php
