        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-11 col-xl-10 text-center my-5 pb-5">
                    ...
                    <div class="col-12">
                        <p class="text-left d-flex flex-column flex-lg-row">
                            ...
                            <div class="col-12">
                                <div class="col-12 pt-3 pb-2 px-0">
                                        ...
                                        <div class="btn-group  col-12 col-lg-6 pxa-0" role="group" aria-label="Basic example">
                                            <div class="d-flex w-100">
                                                <input type="text" class="form-control rounded-0 bg-light"
                                                       placeholder="Find keywords" id="jobs-search">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 px-0 text-left mb-3">
                                        <p class="title_left_sorting text-lg-left text-center pt-2"><strong>Displaying Keywords 1-50 of 100,000</strong></p>
                                    </div>
                                    <div class="row text-left">
                                        <div class="col-12 col-lg-4">
                                            <p><a href="#" class="breadcrumb_custom">Bicycle Store (222)</a></p>
                                            <p><a href="#" class="breadcrumb_custom">Chinese Restaurant (123)</a></p>
                                            <p><a href="#" class="breadcrumb_custom">Meal Takeaway (321)</a></p>
                                            <p><a href="#" class="breadcrumb_custom">Night Club (221112)</a></p>
                                            <p><a href="#" class="breadcrumb_custom">Building Materials Supplier (5)</a></p>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <p><a href="#" class="breadcrumb_custom">Bicycle Store (222)</a></p>
                                            <p><a href="#" class="breadcrumb_custom">Chinese Restaurant (123)</a></p>
