...
@section('content')
    ...
    <div class="d-flex" style="margin-right: 0; margin-top: 15px">
        <div class="jobmap_filter bg-white" style="padding-right: 0; width: 320px; left: 0px; z-index: 1; overflow-y: scroll; height: calc(100vh - 353px); display: none;" id="job-filters">
            <div class="d-flex justify-content-end my-2">
                <a href="#" class="align-self-center pr-3 close_jmFilter" style="white-space: nowrap;"><strong>{!! trans('fields.label.back_to_map') !!}</strong></a>
                <!--<div class="w-100 text-right align-self-center">
                    <button type="button" class="close close_jmFilter mr-3" style="cursor: pointer;">
            ...
            <div class="category_section" style="width: 100%;">
                @if($filters)
                    <div class="col-12 py-2 clear-filters-box" style="border-bottom:1px solid #e9ecef;">
                        <a href="javascript:void(0)" class="cardinal_links clear-all-filter font-16"  style="font-size: 16px;">
                ...
                <div class="bg-white rounded p-0">
                    ...
                    <div class="col-11 mx-auto py-2" style="">
                        <div class="form-group text-center mb-3" style="text-align: left">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.weekly_hours') !!}</strong></span>

                            <div id="slider-hours" class="mt-3 mb-4"></div>
                            <span id="slider-hours-amount" style="background: #eee; padding: 5px; border-radius: 10px;"></span>
                            <!-- <input type="text" id="slider-hours-amount" readonly class="border-0 text-center p-1"> -->
                        </div>
                    </div>

                    <div class="col-12 py-2" style="border-bottom:1px solid #e9ecef; border-top:1px solid #e9ecef;">
                        <span class="title_left_sorting"><strong>{!! trans('fields.label.business_name') !!}</strong></span>
                        <input type="text" name="b_name" value="{{ $getData['b_name'] or "" }}" class="form-control mt-2" autocomplete="off"
                               placeholder="{!! trans('fields.placeholder.business_name') !!}">
                    </div>

                    <div class="col-12 py-2" style="border-bottom:1px solid #e9ecef;">
                        <p class="mb-2"><span class="title_left_sorting "><strong>{!! trans('fields.label.job_title') !!}</strong></span></p>
                        <div id="sub_categories" class="mt-2"></div>

                        {{--<input type="text" name="title" value="{{ $getData['title'] or "" }}" class="form-control mt-2" autocomplete="off"
                               placeholder="{!! trans('fields.placeholder.job_title') !!}">--}}
                    </div>

                    <div class="col-12 py-2" style="border-bottom:1px solid #e9ecef;">
                        <span class="title_left_sorting"><strong>{!! trans('fields.label.location_field') !!}</strong></span>
                        <input type="text" name="location" value="{{ $getData['location'] or "" }}" class="form-control mt-2" autocomplete="off"
                               placeholder="{!! trans('fields.placeholder.location_field') !!}">
                    </div>

                    <!-- BANNER -->
                    <!-- <div class="banner my-3 text-center">
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img src="https://s3.amazonaws.com/newfiles.bannersnack.net/site/images/landingPages/gallery/bcma6f3jo" style="width: 100%;">
                            </div>
                            <div class="carousel-item">
                              <img src="https://i.ytimg.com/vi/d1uzjA6QL4c/maxresdefault.jpg" style="width: 100%;">
                            </div>
                            <div class="carousel-item">
                              <img src="http://www.spulsa.info/wp-content/uploads/mega-html-banner-bundle-01-0effortthemes-codecanyon-html-banners.jpg" style="width: 100%;">
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                        @if(isset($getData['amenities']))
                            <a href="javascript:void(0)"
                               class="cardinal_links remove-all-filter"
                               data-filter="amenities"> <img
                        ...
                        <a href="#" class="open_close_category cardinal_links">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.amenities') !!}</strong></span>
                        ...
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                <?php
                                $data = (isset($getData['amenities'])) ? explode(",", $getData['amenities']) : [];
                                ?>
                                @foreach($amenities as $item)
                                    <li>
                                        @if(in_array($item['id'], $data))
                                            <a href="javascript:void(0)"
                                               class="cardinal_links remove-filter" data-filter="amenities"
                                               data-id="{{ $item['id'] }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $item['name'] }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                    ...
                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                        ...
                        @endif
                        <a href="#" class="open_close_category cardinal_links">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.departments') !!}</strong></span>
                            <span class="float-right plus_icon collapsed"></span>
                        </a>
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                    ...
                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                        ...
                        @endif
                        <a href="#" class="open_close_category cardinal_links">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.languages') !!}</strong></span>
                            <span class="float-right plus_icon collapsed"></span>
                        </a>
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                    ...
                    <!-- ONE CATEGORY START -->
                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                        @if(isset($getData['certifications']))
                            <a href="javascript:void(0)"
                               class="cardinal_links remove-all-filter"
                               data-filter="languages"> <img
                                        src="{{ asset('img/round-delete-button.svg') }}"
                        ...
                        @endif
                        <a href="#" class="open_close_category cardinal_links">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.certifications') !!}</strong></span>
                            <span class="float-right plus_icon collapsed"></span>
                        </a>
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                    ...
                    <div class="col-12 py-2 filter-group" style="border-bottom:1px solid #e9ecef;">
                        ...
                        @endif
                        <a href="#" class="open_close_category cardinal_links">
                            <span class="title_left_sorting"><strong>{!! trans('fields.label.popular_keywords') !!}</strong></span>
                            <span class="float-right plus_icon collapsed"></span>
                        </a>
                        <div class="content_category" style="display: none">
                            <p class="mb-1 mt-3 px-2">
                            <div id="a_keywords"></div>
                            ...
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($keywords as $keyword)
                                    <li>
                                        <a href="javascript:void(0)"
                                           class="cardinal_links add-filter-ms"
                                           data-filter="keywords"
                                           data-id="{{ $keyword['id'] }}">{{ $keyword['name'] }}</a>
                                    </li>
                                @endforeach
                            </ul>
                            {{--<p class="mb-0 mt-2 px-2">--}}
                            {{--<a href="http://jobmap.co/popular_keywords"--}}
                            {{--class="btn btn-outline-primary seeall_btn">See all</a>--}}
                            {{--</p>--}}
                        </div>
                    </div>
                    <!-- ONE CATEGORY END -->
                                        ...
                                        @if(in_array($v, $postedData))
                                            <a href="javascript:void(0)"
                                               ...
                                               data-id="{{ $v }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $v }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="posted" data-id="{{ $v }}">{{ $v }}</a>
                                        @endif
                                    </li>
                                @endforeach
                        ...
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($employers as $k => $v)
                                    <li>
                                        @if(in_array($k, $employersData))
                                            <a href="javascript:void(0)"
                                               class="cardinal_links remove-filter"
                                               data-filter="employers"
                                               data-id="{{ $k }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $v }}</span>
                            ...
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($industries as $industry)
                                    <li>
                                        <a href="javascript:void(0)"
                                           class="cardinal_links add-filter-ms"
                                           data-filter="popular_industries"
                                           data-id="{{ $industry['id'] }}">{{ $industry['name'] }}</a>
                                    </li>
                                @endforeach
                            </ul>
                            <p class="mb-0 mt-2 px-2">
                        ...
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($types as $type)
                                    <li>
                                        @if(in_array($type['id'], $typesData))
                                            <a href="javascript:void(0)"
                                               class="cardinal_links remove-filter" data-filter="types"
                                               data-id="{{ $type['id'] }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $type['name'] }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="types"
                                               data-id="{{ $type['id'] }}">{{ $type['name'] }}</a>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
                                        ...
                                        @if(in_array($i, $opData))
                                            <a href="javascript:void(0)"
                                               ...
                                               data-id="{{ $i }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $option }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="options"
                        ...
                        <div class="content_category" style="display: none">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($careers as $career)
                                    <li>
                                        @if(in_array($career['id'], $careersData))
                                            <a href="javascript:void(0)"
                                               class="cardinal_links remove-filter"
                                               data-filter="careers"
                                               data-id="{{ $career['id'] }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $career['name'] }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="careers"
                                               data-id="{{ $career['id'] }}">{{ $career['name'] }}</a>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
                                        ...
                                        @if(isset($getData['time_'.$t]))
                                            <a href="javascript:void(0)"
                                               ...
                                               data-id="time_{{ $t }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $time }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="time_{{ $t }}"
                                               data-id="1,2,3,4,5,6,7">{{ $time }}</a>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="content_category" style="display: none;">
                            <ul class="pl-2 mb-2 mt-2" style="list-style: none;">
                                ...
                                @foreach($sizes as $size)
                                    <li>
                                        @if(in_array($size['id'], $sizesData))
                                            <a href="javascript:void(0)"
                                               class="cardinal_links remove-filter" data-filter="sizes"
                                               data-id="{{ $size['id'] }}"> <img
                                                        src="{{ asset('img/round-delete-button.svg') }}"
                                                        style="width: 15px; opacity: 0.3; margin-top: -3px; margin-right: 9px;"></a>
                                            <span class="cardinal_links active">{{ $size['name'] }}</span>
                                        @else
                                            <a href="javascript:void(0)"
                                               class="cardinal_links add-filter"
                                               data-filter="sizes"
                                               data-id="{{ $size['id'] }}">{{ $size['name'] }}</a>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
            ...
            <!-- SOCIAL BLOCK -->
            <!-- <div class="m-3 border rounded py-3">
                <p class="px-3" style="font-size: 20px;">Lets Get Social</p>
                <hr>
                <p class="px-3">Stay connected to the lates jobs, events and career advice from Monster through social media</p>
                <div class="d-flex justify-content-between mb-3 px-3">
                    <a href="#">
                        <img src="{{ asset('img/icons/instagram.svg') }}" width="40px" height="40px">
                    </a>
                    <a href="#">
                        <img src="{{ asset('img/icons/facebook.svg') }}" width="40px" height="40px">
                    </a>
                    <a href="#">
                        <img src="{{ asset('img/icons/twitter.svg') }}" width="40px" height="40px">
                    </a>
                    <a href="#">
                        <img src="{{ asset('img/icons/linkedin.svg') }}" width="40px" height="40px">
                    </a>
                </div>
            </div> -->
            <!-- /SOCIAL BLOCK -->
        ...
        <div class="px-0" style="flex:1; position: relative; ">
            ...
            <div id="job-map" style="height: calc(100vh - 153px); position: relative;"></div>
