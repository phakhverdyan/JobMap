            ...
            <div class="container py-5">
                <div class="col-12">
                    ...
                    <g>
                        ...
                        <strong>{!! trans('main.explore_employers') !!}</strong>
                    </p>
                    ...
                    <div class="col-12 px-0" style="margin-top: 70px;">
                        <p class="title_left_sorting">
                            <strong>{!! trans('main.label.all_employers') !!}</strong>
                        </p>
                        <div class="row">
                            <?php
                            $i = 0;
                            ...
                            <div class="col-lg-3 col-12 col-md-6">
                                ...
                                <p>
                                    <a href="{!! url('/') . '/business/view/' . $l['id'] . '/' . $l['slug'] !!}"
                                       target="_blank" class="cardinal_links" style="font-size: 17px;">
