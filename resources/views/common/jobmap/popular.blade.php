                    ...
                    <div class="card border-0">
                        <div class="card-body px-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-11">
                                    <div class="col-12">
                                        <p class="title_left_sorting text-left"><strong>{!! trans('main.latest_popular_keywords') !!}</strong>
                                        </p>
                                            ...
                                            @foreach($keywords as $keyword)
                                                @if($i == 0)
                                                    <div class="col-12 col-md-4">
                                                        @endif
                                                        <p><a href="/search/jobs?a_keywords={{ $keyword['id'] }}"
                    ...
                    <div class="card border-0">
                        <div class="card-body px-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-11">
                                    <div class="col-12">
                                        <p class="title_left_sorting text-left"><strong>{!! trans('main.by_country') !!}</strong></p>
                                        <div class="row text-left">
                                            @php
                                                $i = 0;
                                                $j = 0;
                                            ...
                                            @foreach($countries as $country)
                                                @if($i == 0)
                                                    <div class="col-12 col-md-4">
                                                        @endif
                                                        <p>
                                                    <span><i class="glyphicon bfh-flag-{{ $country->country_code }}"
                                                             style="vertical-align: middle; margin-top: -3px;"></i></span>
                                                            <a href="/popular/{{ $country->name }}"
                                                               class="cardinal_links">{{ $country->name }}</a>
                                                        </p>
                                                        @php
                                                            ++$i;
                                                            ++$j;
