...
<div class="card border-0 col-md-12 px-0">
    <div class="card-header bg-white border-0 py-3 BobikHoverEffect text-left" role="tab" id="headingL{{ $args['id'] }}">
        <h5 class="mb-0 mt-0">
            ...
            <a class="collapsed Bobik" data-toggle="collapse" href="#collapseL{{ $args['id'] }}" aria-expanded="true"
               aria-controls="collapseL{{ $args['id'] }}" style="font-size: 16px; font-family: sans-regular; color: #4E5C6E;">

                {{ $args['name'] }}
            </a>

            <div class="btn-group float-right mr-3" role="group">
                <button id="btnGroupDropL{{ $args['id'] }}" type="button"
    ...
    <div id="collapseL{{ $args['id'] }}" class="collapse text-left" role="tabpanel" aria-labelledby="headingL{{ $args['id'] }}" data-parent="#accordion1">
