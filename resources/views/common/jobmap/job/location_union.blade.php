...
@section('content')
    ...
    <div id="business-view" style="margin-top: 15px; overflow: hidden;">
        <!-- left menu begin -->
        <!-- <div class="col-md-3">menu</div> -->
        <!-- left menu eof -->

        <!-- content block begin-->
        <div class="text-center py-4" style="background-color: rgba(0,0,0,0.6); position: absolute; width: 100%; z-index: 9">
            <p class="px-4 align-self-center mb-0">
                <a href="" id="link-location-world"
                ...
                <a href="" id="link-location-address"
                   class="text-white" data-toggle="tooltip" data-placement="top"
                   title="Explore building/location">data->street</a>
                <span style="opacity: 0.4;">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         version="1.1" id="Capa_1" x="0px" y="0px" width="13px" height="13px"
                         viewBox="0 0 292.359 292.359"
        ...
        <p class="text-center mb-0" style="position: absolute; left: 0; right: 0; margin-top: -75px; z-index: 1;"><a href="http://jobmap.co/map" role="button" class="btn btn-primary" >Back to Career Page</a></p>
                ...
                <div class="d-flex justify-content-between flex-lg-row flex-column pt-2">
                    <div class="d-flex flex-lg-row flex-column">
                        <div class="pxa-0 mxa-0 text-center text-md-left align-self-center mr-3 careerpage_businessname bg-white"
                            ...
                            <img class="business-icon rounded careerpage_icon wow animated fadeInDown"
                                 src="{{ url('/') }}/business/54/100.100.9ad7139a8000a876e12bed3f20655257.jpg?v=48818" style="width: 200px; border:5px solid #fff;">
                        </div>
                ...
                <div class="col-12 px-0">
                    <div class="d-flex flex-lg-row flex-column justify-content-end">
                        ...
                        <div class="flex-1 d-flex flex-lg-row flex-column justify-content-between py-2">
                            <div class="d-flex flex-sm-row flex-column justify-content-between justify-content-lg-start">
                                <div class="text-center py-3 mxa-0 mr-5">
                                    <div class="mb-3 mb-lg-0">
                                        <a href="" class="business_tabs mxa-0 active">
                                            <span id="job-count">Opened Jobs 1</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="text-center py-3 mxa-0 mr-5">
                                    <div class="mb-3 mb-lg-0">
                                        <a href="" class="business_tabs mxa-0 mb-3 mb-lg-0">
                                            <span id="headquarter-count">Closed Jobs 1</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <button class="btn btn-success send-resume w-100 mr-3 mb-3 mb-lg-0"
                                    ...
                                    <span class="mb-0 pb-2" style="font-weight: 400;">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             style="enable-background:new 0 0 426.667 426.667; vertical-align: middle; margin-top: -3px;"
                ...
                <div class="d-flex flex-lg-row flex-column mt-3">
                    <div class="mr-5 col-lg-3 col-12 px-0 mt-3">
                        ...
                        <p class="mb-0" id="website" class="regural_text_style">
                            ...
                            <a target="_blank"
                               href=""
                               class="regural_text_style">data->website</a>
                        </p>

                        <div class="col-md-12 my-3 border" id="map" style="height: 160px; border-radius: 15px;"></div>
                        <div class="text-left py-2 pb-4 title_left_sorting rounded mt-3" style="font-size: 14px;">
                            <p class="mb-0 text-justify"><i
                                        class="glyphicon bfh-flag-ca"></i>
                                <strong>_industry, _sub_industry</strong></p>
                            <p class="mb-0 text-justify"> _size Employees</p>
                            <p class="mb-0 text-justify"><strong>type</strong></p>
                            <p class="mb-0 text-justify"><strong>{!! trans('main.label.hiring_languages') !!}</strong>_languages</p>
                            <p id="business-description" class="mt-3 text-justify">data->description</p>
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="title_left_sorting text-left d-flex flex-column flex-lg-row py-3">
                                            <div class="d-flex col-12 pl-0 col-lg-4 pxa-0 justify-content-between mb-3 mb-lg-0" style="background-color: #f4f4f4; box-shadow: none; border-radius: 10px;">
                                                <input type="text" class="form-control border-0 ml-2" style="background-color: #f4f4f4; box-shadow: none; border-radius: 10px;" placeholder="Find Jobs" id="items-search" value="">
                                            ...
                                            <div class="d-flex ml-auto w-100 justify-content-between justify-content-lg-end flex-md-row flex-column">
                                                <div class="d-flex mr-0 pt-1 mb-3 mb-md-0">
                                                    <span class="pt-2 mr-0">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 417.138 417.138" style="height:15px; opacity: 0.8; fill:#184ba2;" xml:space="preserve">
                                                        <g>
                                                            <g>
                                                                <path d="M153.289,333.271c9.35,0,17-7.65,17-17v-299.2c0-6.517-3.683-12.467-9.35-15.3c-5.667-2.833-12.75-2.267-17.85,1.7    l-111.067,83.3c-7.65,5.667-9.067,16.15-3.4,23.8c5.667,7.65,16.15,9.067,23.8,3.4l83.867-62.9v265.2    C136.289,325.621,143.939,333.271,153.289,333.271z"></path>
                                                                <path d="M263.789,86.771c-9.35,0-17,7.65-17,17v296.367c0,6.517,3.683,12.183,9.35,15.3c2.55,1.133,5.1,1.7,7.65,1.7    c3.683,0,7.083-1.133,10.2-3.4l111.067-81.883c7.65-5.667,9.067-16.15,3.683-23.8c-5.667-7.65-16.15-9.067-23.8-3.683    l-84.15,62.05v-262.65C280.789,94.421,273.139,86.771,263.789,86.771z"></path>
                                                            </g>
                                                        </g>
                                                        </svg>
                                                    </span>
                                                    <select class="border-0 form-control form-control-sm bg-white" id="items-sort" style="box-shadow: none!important; color:#47546b;">
                                                            <option value="title" data-order="asc">Title A-Z
                                                            </option>
                                                            <option value="title" data-order="desc">Title Z-A
                                                            </option>
                                                            <option value="created_date" data-order="asc">Created Date - Oldest
                                                            </option>
                                                            <option value="created_date" data-order="desc">Created Date - Newest
                                                            </option>
                                                    </select>
                                                </div>
                                                <div class="pt-1 mr-2 mb-3 mb-md-0">
                                                    <select class="border-0 form-control form-control-sm bg-white" id="items-limit" style="box-shadow: none!important; color:#47546b;">
                                                        ...
                                                        <button class="btn btn-primary rounded d-flex" type="button" aria-expanded="false" data-toggle="modal" data-target="#jobfiltermodal" id="filters-modal" style="background-color: #fff; border:1px solid #4E5C6E; color:#4E5C6E;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 511.999 511.999" xml:space="preserve" height="20px" style="fill:#4E5C6E;" class="mr-2 align-self-center">
                                                ...
                                                <div class="col-12 px-0">
                                                    <div class="d-flex flex-column flex-lg-row pxa-0 p-3" style="border-bottom:1px solid #e9ecef;">
                                                        <div class="text-center text-lg-left">
                                                            <img src="{{ url('/') }}/business/1/50.50.4f22741d861fd92fda0032fe424a5a21.png?v=98065" class="rounded" style="width: 60px; height: 60px;">
                                                        </div>
                                                        <div class="ml-4 mxa-0 text-center text-lg-left w-100">
                                                            <div class="d-flex justify-content-between flex-column flex-lg-row">
                                                                <div class="mb-2">
                                                                    <a href="http://jobmap.co/map/view/job/1" data-id="2" class="view-job-link open-sans" style="font-size: 16px; color:#1D1D1D; font-weight: bold;"> Forn-eneda</a>
                                                                </div>
                                                                <div class="pt-1" style="opacity: 0.4;">
                                                                  <span class="ml-2 mxa-0">2 months ago</span>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-between mt-3 px-lg-0 px-3">
                                                                ...
                                                                <div class="align-self-center">
                                                                  <span class="ml-2" data-toggle="tooltip" title="" data-original-title="Email &amp; share this job">
                                                                      <a data-toggle="modal" data-target="#ShareModal" data-id="1">
                                                                ...
                                                                <div class="align-self-center">
                                                                  <a href="http://jobmap.co/map/view/job/1" data-id="2" class="view-job-link btn border-0 px-4 py-1" role="button" style="background-color: #4266ff; color:#fff; border-radius: 20px;">VIEW JOB</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
@section('script')
    ...
    <script src="{{ asset('/js/jobmap/parallax.min.js') }}"></script>
