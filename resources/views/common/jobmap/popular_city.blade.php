            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-11 col-xl-10 text-center my-5">
                    ...
                    <p class="title_left_sorting d-flex animated fadeInDown" style="font-size: 24px;">
                        ...
                        <strong>{!! trans('main.popular') !!}</strong>
                    </p>
                    ...
                    <div class="card">
                        <div class="card-body px-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-11">
                                    <div class="col-12">
                                        <p class="title_left_sorting text-left"><strong>{!! trans('main.latest_popular_keywords_id', ['item' => $country]) !!}</strong>
                                        </p>
                                            ...
                                            @foreach($keywords as $keyword)
                                                @if($i == 0)
                                                    <div class="col-12 col-md-4">
                                                        @endif
                                                        <p><a href="/search/jobs?a_keywords={{ $keyword->id }}&location={{ $country }}"
                                                              class="cardinal_links">{{ $keyword->name }}</a></p>
                                                        @php
                                                            ++$i;
                                                            ++$j;
                                                        @endphp
                ...
                <div class="col-12 col-lg-11 col-xl-10 text-center mb-3">

                    <p class="title_left_sorting d-flex animated fadeInDown" style="font-size: 24px;">
                        <strong>{!! trans('main.explore_keywords') !!}</strong>
                    </p>
                    ...
                    <div class="card">
                        <div class="card-body px-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-11">
                                    <div class="col-12">
                                        <p class="title_left_sorting text-left"><strong>{!! trans('by_city_in', ['item' => $country]) !!}</strong></p>
                                        <div class="row text-left">
                                            @php
                                                $i = 0;
                                                $j = 0;
                                            ...
                                            @foreach($cities as $city)
                                                @if($i == 0)
                                                    <div class="col-12 col-md-4">
                                                        @endif
                                                        <p>
                                                    <span><i class="glyphicon bfh-flag-{{ $city->country_code }}"
                                                             style="vertical-align: middle; margin-top: -3px;"></i></span>
                                                            <a href="/popular/{{ $city->name }}/{{ $country }}"
                                                               class="cardinal_links">{{ $city->name }}</a>
                                                        </p>
                                                        @php
                                                            ++$i;
                                                            ++$j;
