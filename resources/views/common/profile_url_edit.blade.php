...
<div class="container-fluid">
    <div class="row">
        <div class="col-10 mx-auto billing-info-wrapper">
        <div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-10 text-center my-4">
                                                    ...
                                                    <div class="col-10">
                                                        <div class="p-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="mr-2">
                                                                    <img src="{{ asset('img/flags/shiny/16/Ukraine.png') }}"
                                                                        alt="company-flag">
                                                                </div>
                                                                <p class="mb-0"
                                                                style="opacity: 0.8;">
                        ...
                        <div class="card mb-5">
                            <div class="card-header py-4  bg-white">
                                <div>
                                    <svg version="1.1" class="d-block mx-auto mb-1" width="50px" height="50px" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        ...
                        <div class="card mb-5">
                            <div class="card-header py-4  bg-white">
                                <div>
                                    <svg version="1.1" id="Layer_1" class="d-block mx-auto mb-1" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        ...
                        <div class="card">
                            <div class="card-header py-4 bg-white">
                                <div>
                                    <svg version="1.1" id="Capa_1"  class="d-block mx-auto mb-1" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
