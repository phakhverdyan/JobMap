        ...
        <div class="col-md-12 card rounded-0 border-top-0 py-3">
            <div class="row">
                <div class="col-md-7 text-center">
                    <p class="mb-0"><a href="#"
                                       style="text-decoration: none;"> {!! trans_choice('main.counters.c_open_positions', $args['jobs_count_open'], ['count' => $args['jobs_count_open']]) !!}</a>
                    </p>
                </div>
                <div class="col-md-5 text-center">
                    <p class="mb-0"><a href="#" style="text-decoration: none;"> {{ $args['jobs_count_close'] }}
                            {!! ucfirst(trans('main.status.closed')) !!}</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 pt-0 card rounded-0 border-top-0 border-bottom-0">
            ...
            <!-- <div class="col-md-6 mx-auto">
                ...
                <div class="col-md-12 my-3 mx-auto">
                    <button class="btn btn-outline-primary btn-block  py-2 send-resume" data-id="{{ $args['id'] }}"
                            data-b-id="{{ $args['business']['id'] }}">Send
                        CloudResume
                    </button>
                </div>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-8 px-0">
                    <a href="{{ url('/map/view/location/' . $args['id']) }}"
                       ...
                       style="border-bottom-right-radius: 0px; border-bottom-left-radius: 5px; border-top-left-radius: 0px; border-top-right-radius: 0px;">
                        {!! trans('main.buttons.view_location') !!}
                    </a>
                </div>
