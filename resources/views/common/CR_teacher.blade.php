			...
			<div class="container">
				<div class="col-12 mt-5 wow animated fadeInDown">
					<div class="d-flex justify-content-center flex-lg-row flex-column">
						...
						<div class="col-12 col-lg-3 my-1">
							<a href="{!! url('/CR-teacher') !!}" role="button" class="btn btn-landing py-2 btn-block active">
					...
					<div class="text-center col-12 col-lg-6 mx-auto mt-5"> 
						<div class="mb-3 mx-auto text-center font-16">
							Track your student's career progress		
						</div>
					...
					<div class="col-12 col-lg-6 mx-auto">
						...
						<p class="mt-3"><input type="text" name="" placeholder="What are you teaching" class="form-control rounded"></p>
