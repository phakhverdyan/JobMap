...
<body>
    <div class="container" style="margin-top: 60px;">
        <div class="col-12">
            ...
            <p class="text-center mb-5" style="font-size: 30px;">Let's set up your CloudResume</p>
            <div class="d-flex justify-content-center flex-column-reverse flex-lg-row">
                <div class="border rounded bg-white p-3 mr-3 we_help_you width-100-lg mb-3" style="display: none;">
                ...
                <div class="width-100-lg mb-3">
                    <div class="border rounded p-3">
                        <p class="text-center" style="font-size: 17px;">Do you own a <strong>website?</strong></p>
                        <div class="d-flex justify-content-around flex-column flex-lg-row" data-toggle="buttons">
                            <label class="btn btn-outline-primary option01">
                            ...
                            <label class="btn btn-outline-primary option02" >
                                <input type="radio" name="looking_job" id="option02"  autocomplete="off" checked="" value="yes">
                                <span>
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none;" class="mr-2 active_icon ">
                                    No<span class="hide_text">, we don't have one</span>
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="border rounded p-3 mt-3">
                        <p class="text-center" style="font-size: 17px;">Does your website have a <strong>job posting</strong> section?</p>
                        <div class="d-flex justify-content-around flex-column flex-lg-row" data-toggle="buttons">
                            <label class="btn btn-outline-primary option01">
                                <input type="radio" name="looking_job" id="option01"  autocomplete="off" checked="" value="yes">
                                <span>
                            ...
                            <label class="btn btn-outline-primary option02">
                                ...
                                <span>
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none;" class="mr-2 active_icon option01">
                                    No<span class="hide_text">, we don't have a job section on our website</span>
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="border rounded p-3 mt-3">
                        ...
                        <p class="text-center mt-2 font-response-14" style="font-size: 17px;">Do you use free emails to receive candidates such as <strong>apply.yourcompany@GMAIL.COM</strong> ?</p>
                        <div class="d-flex justify-content-around flex-column flex-lg-row" data-toggle="buttons">
                            <label class="btn btn-outline-primary option01">
                                <input type="radio" name="looking_job" id="option01"  autocomplete="off" checked="" value="yes">
                                <span>
                            ...
                            <label class="btn btn-outline-primary option02">
                                ...
                                <span>
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none;" class="mr-2 active_icon option01">
                                    No<span class="hide_text">, we have a CUSTOM email address</span>
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div class="mt-3">
                <a  href="{!! url('/lets-get-started2') !!}" role="button" class="btn btn-primary btn-block col-lg-6 col-11 mx-auto">Next</a>
            </div>
        </div>
    </div>
