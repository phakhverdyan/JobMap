		...
		<div class="container">
			<div class="col-12 pb-5">
				<div class="d-flex justify-content-between flex-lg-row flex-column-reverse">
					<div class="col-lg-8 col-md-12 mt-3" id="blockActive">
						<p class="mb-1"><strong><span id="academyUserName"></span> {{ $child }} <span id="academyChildrenActiveCount"></span></strong></p>
						<p class="text-muted mb-0" id="academyUserTeaching"></p>
						<p class="text-muted">
							<a href="jawascript:;" id="academyUserAcademy"></a>
							<span id="academyUserCountryCode" style="vertical-align: middle; margin-top: -3px;" class="item-location-flag">
								<i class="glyphicon"></i>
							</span>
							<span id="academyUserLocation"></span>
						</p>
						<div class="d-flex w-100 justify-content-between flex-md-row flex-column" id="cloneChildActive" style="display: none!important;">
							<div class="d-flex">
								<div>
									<a href="jawascript:;" class="academyChildPic">
										<img src="" style="width: 70px; height: 70px;" class="mr-3 rounded">
									</a>
								</div>
								<div>
									<p class="mb-1 font-18">
										<a href="jawascript:;" class="academyChildName" style="color:#3e4552;">
											<strong></strong>
										</a>
									</p>
									<p class="text-muted mb-0 academyChildTeaching"></p>
									<p class="text-muted">
										<span class="text-muted academyChildAcademy"></span>
										<span style="vertical-align: middle; margin-top: -3px;" class="item-location-flag academyChildCountryCode">
											<i class="glyphicon"></i>
										</span>
										<span class="academyChildLocation"></span>
									</p>
								</div>
							</div>
							<div>
								<p class="text-muted mb-0 academyChildDateAdd"></p>
								<p class="text-muted academyChildDateUpdate"></p>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-12 mt-3">
						<p class="text-center"><strong>Add {{ $child }}</strong></p>
						<p>
							<div class="input-group col-12 mb-3 px-0" id="formInviteChild">
                                <div class="d-flex" style="box-shadow: inset 0 1px 1px rgba(0,0,0,0.075);border: 1px solid rgba(78,92,110,.1); border-top-left-radius: 5px; border-bottom-left-radius: 5px; flex: 1;">
									...
									<div class="d-flex flex-column w-100">
										<input name="email" type="text" class="form-control border-0 bg-white w-100" placeholder="{{ ucfirst($child) }} email" style="box-shadow: none; height: 30px; margin-top: 3px;">
									</div>

                                </div>
                                <button id="inviteChild" class="btn btn-outline-primary mx-0" type="button" style="border-top-left-radius: 0; border-bottom-left-radius: 0;">
							...
							<div class="input-group col-12 mx-auto mb-3 px-0">
			                    <div class="d-flex" style="box-shadow: inset 0 1px 1px rgba(0,0,0,0.075);border: 1px solid rgba(78,92,110,.1); border-top-left-radius: 5px; border-bottom-left-radius: 5px; flex: 1;">
			                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 426.995 426.995" style="enable-background:new 0 0 426.995 426.995; margin-top: 4px; fill:#9BA6B2;" xml:space="preserve" width="30px" height="30px" class="mx-2">
			                        	...
			                        	<input name="token" id="link-user-profile" type="text" class="form-control border-0 bg-white" readonly placeholder="" style="box-shadow: none; height: 30px; margin-top: 3px;">
			                    </div>
						...
						<p><strong><span id="academyChildrenInActiveCount"></span> Invites sent</strong></p>
						<div id="blockInActive">
							<div class="w-100 itemChildInActive" id="cloneChildInActive" style="display: none">
								<p class="text-muted mb-0 academyChildEmail">11</p>
								<div class="d-flex justify-content-between flex-sm-row flex-column">
									<span class="mr-3 pt-2 academyChildData">3 days ago</span>
									<span class="reInviteChild"><button class="btn btn-sm btn-landing font-16">Resend</button></span>
								</div>
							</div>
						</div>
					</div>
