	...
	<div class="container-fluid px-0">
		<div class="col-12 px-0">
			<div class="col-12 bg-white buttons_div">
				...
				<div class="container">
					<div class="col-12">
						<p class="text-center mb-0 pb-3 mt-5"><img src="{{ asset('img/landing/cr-logo.png') }}" width="70px" class="wow animated fadeInDown"></p>
					</div>
				</div>
			</div>
					...
					<div class="col-12 mt-3 wow animated fadeIn">
						<div class="d-flex justify-content-center flex-lg-row flex-column">
							<div class="col-12 col-lg-3 my-1">
								<a href="{!! url('/CR-landing') !!}" role="button" class="btn btn-landing active py-2 btn-block">
							...
							<div class="col-12 col-lg-3 my-1">
								<a href="{!! url('/CR-director') !!}" role="button" class="btn btn-landing py-2 btn-block">
		...
		<footer class="py-5" style="background: #343434;">
			<div class="container">
				<p class="text-center mb-0">
					<img class="p-0" src="{{ asset('/img/C_logo_white.png') }}" width="45px">
				</p>
			</div>
		</footer>
