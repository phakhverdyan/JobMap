...
<body style="background-color: #eee;">
	...
	<tr>
		<td align="center" style="opacity: 0.7; font-size: 11px; padding-top: 20px;  padding-bottom: 20px;">
			JobMap turns static applicants into never-expiring live candidates, in order to get interviews and chat via instant messages - used by large, medium and small employers all over the world.
		</td>
	</tr>
	...
	<table align="center" width="600">
		...
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px; padding-top: 20px;">
				JobMap will send you notifications as per your account settings.
			</td>
		</tr>
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px;">
				Please log in if you desire to change alert options.
			</td>
		</tr>
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px;">
