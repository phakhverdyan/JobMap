...
<body style="background-color: #eee;">
	...
	<table align="center" width="600" style="border-collapse: collapse; background: #fff; border-radius: 5px;">
 	...
 	<tr>
		<td align="center" style="display: flex; justify-content: center;">
			<a href="" style="margin:0 10px;">
				<img src="https://ci5.googleusercontent.com/proxy/9L-bXDcAqQNo-cZF5uh4T2-veCe1S8OK_E_fQqONZ2Em33zmZahVJTwsscv62JRH7SaGk03YgcYJM5LUByh97ALsgbfYem2jvHSygi36NOdqJw4dYv8IRLhTJUIoI7CNxNJLdkQ=s0-d-e1-ft#http://pubs.payoneer.com/EmailSender/Payoneer/img/Default/BlocksTemplate/fb.jpg">
			</a>
			<a href="" style="margin:0 10px;">
				<img src="https://ci6.googleusercontent.com/proxy/e-gOzUe98seyyEoLiad_43zM5BoPZ-r0w1rV8n-xLlksIc0XInTlBUuVvPDalGpLji7v-hqXH3aMTA8Mm_twg7RiD2kWAcVR1rGd4s_cLab_RZQARzm23FXKkzRTYGAanxohINw=s0-d-e1-ft#http://pubs.payoneer.com/EmailSender/Payoneer/img/Default/BlocksTemplate/li.jpg">
			</a>
			<a href="" style="margin:0 10px;">
				<img src="https://ci4.googleusercontent.com/proxy/t_UQri1E_CeWF5hbfwMthtUz6hcu2W3nfhefvBh-8QD7fPzk18F7E5MMmIrjURRJY9Ys-X7CEyE9LAuH4L0kIHXZuaIV7wgFlUBa43I9Ag_iucwmPYTp7zxqXipO2vYW3rhlevY=s0-d-e1-ft#http://pubs.payoneer.com/EmailSender/Payoneer/img/Default/BlocksTemplate/yt.jpg">
			</a>
		</td>
	</tr>
	...
	<tr>
		<td align="center" style="opacity: 0.7; font-size: 11px; padding-top: 20px;  padding-bottom: 20px;">
			JobMap rend les candidats statiques en candidats actifs, afin d'obtenir des entrevues et de discuter via des messages instantanés - utilisés par les grandes, moyennes et petites entreprises du monde entier.
		</td>
	</tr>
	...
	<table align="center" width="600">
		...
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px; padding-top: 20px;">
				JobMap vous envois des notifications selon les paramètres de votre compte.
			</td>
		</tr>
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px;">
				Veuillez vous connecter si vous souhaitez modifier les options d'alerte.
			</td>
		</tr>
		<tr>
			<td align="center" style="opacity: 0.7; font-size: 11px;">
