        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-8 mx-auto mt-3 ">
                <div class="col-12 rounded bg-white py-3 help-how-to-start-block">
                    ...
                    <p class="text-center">{!! trans('guides.cr_email.time') !!}</p>
                    <div class="d-flex flex-column flex-lg-row justify-content-between mt-5">
                        <div class="text-center col-lg-3 col-12">
                            ...
                            <p><strong>{!! trans('guides.cr_email.link_1') !!}</strong></p>
                        </div>
                        <div class="text-center col-lg-3 col-12">
                            <p>
                            ...
                            <p><strong>{!! trans('guides.cr_email.link_2') !!}</strong></p>
                        </div>
                        <div class="text-center col-lg-3 col-12">
                            <p>
                            ...
                            <p><strong>{!! trans('guides.cr_email.link_3') !!}</strong></p>
                        </div>
                        <div class="text-center col-lg-3 col-12">
                            <p>
                            ...
                            <p><strong>{!! trans('guides.cr_email.link_4') !!}</strong></p>
                        </div>
                    </div>
                    
                    <p class="mt-5"><strong>{!! trans('guides.cr_email.text_box_1.title') !!}</strong></p>
                    <ul style="list-style: none;" class="pxa-0">
                        <li>{!! trans('guides.cr_email.text_box_1.text') !!}</li>
                    </ul>

                    <div class="d-flex flex-column-reverse">
                        <div class="col-12 pxa-0 pl-0">
                            <p class="mt-3"><strong>{!! trans('guides.cr_email.text_box_2.title') !!}</strong></p>
                            <ul style="list-style: none;" class="pxa-0">
                                {!! trans('guides.cr_email.text_box_2.text', [
                ...
                <div class="col-12 rounded bg-white mb-3">
                    <div class="d-flex justify-content-around flex-lg-row flex-column mt-5">
                        <div class="mx-auto text-center">
                            <p><strong>{!! trans('pages.title.cr_email') !!}</strong></p>
                            <p class="mb-0">{!! trans('pages.text.cr_email.item_1') !!} </p>
                            <div class="btn-group col-12 mx-auto mb-3">
                                <input type="text" name="" class="form-control border-top-right-0 border-bottom-right-0" value="apply.BusinessName@jobmap.co" readonly>
                                <button class="btn btn-primary">{!! trans('main.buttons.copy') !!}</button>
                            </div>
                            <p>{!! trans('pages.text.cr_email.item_2') !!}</p>
                        </div>
                    </div> 
                </div>
