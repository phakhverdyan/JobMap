...
@section('content')
    ...
    <div class="container-fluid">
        <form id="business-brand-form" autocomplete="off">
            <div class="row">
                ...
                <div class="col-xl-8 col-11 mx-auto pb-5 mt-5 bg-white rounded content-main">
                            ...
                            <div class="row px-3">
                                <div class="col-md-12 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-column flex-md-row">
                                        <div class="pl-3 py-2">
                                            <a href="{!! url('/business/signup') !!}" id="business-brand__add-btn"
                                ...
                                <div class="d-flex flex-lg-row flex-column justify-content-start" role="group"
                                    ...
                                    <div class="d-flex col-12 pl-0 col-lg-4 pxa-0 justify-content-between mb-3 mb-lg-0"
                                        ...
                                        <input type="text" class="form-control border-0 ml-2"
                                               style="background-color: #f4f4f4; box-shadow: none; border-radius: 10px;"
                                               placeholder="{!! trans('fields.placeholder.cr_brands_search') !!}"
                                               id="business-brand-search"  autocomplete="off">
                    ...
                    <div class="row">
                        <div id="accordion" class="business-brand-list w-100 col-md-12" role="tablist">
    ...
    @include('components.modal.share_brand_modal')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{!! trans('modals.title.brand') !!}</h5>
                ...
                <div class="modal-body">
                    <div class="conteiner">
                        <div class="row justify-content-center">
                            <div class="col-11">
                                {!! trans('modals.text.remove_brand') !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-center bg-light">
                    <div class="bg-white">
                        ...
                        <button type="button" class="btn btn-outline-primary"
                                id="business-brand-confirm-delete">
...
@endsection
@section('script')
    <script src="{{ asset('/js/app/business-brand.js?v='.time()) }}"></script>
@endsection
