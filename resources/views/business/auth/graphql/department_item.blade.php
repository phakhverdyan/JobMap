<div class="card border-0 department-item" data-item-id="{{ $args['id'] }}">
        ...
        <h5 class="mb-0 mt-0">
            <a class="collapsed Bobik" data-toggle="collapse" href="#collapse{{ $args['id'] }}"
               ...
               style="font-size: 16px; font-family: sans-regular; color: #4E5C6E;">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; fill:#7b7b7b; vertical-align: middle; margin-top: -3px;" xml:space="preserve" width="17px" height="19px" class="mr-2">
                  <g>
                      <g>
...
{{--                    <button class="dropdown-item business-department-assign" type="button" role='button'--}}
{{--                            data-toggle="modal" data-target="#ManaInLocModal" data-id="{{ $args['id'] }}">{!! trans('main.buttons.quick_apply') !!}--}}
                    <button class="dropdown-item business-department-assign-new" data-toggle="modal" data-target="#ManaInLocModal" type="button" role='button' data-id="{{ $args['id'] }}">{!! trans('main.buttons.quick_apply') !!}
                    </button>
                    <a class="dropdown-item" href="{{ url('/business/manage/department/edit?id='.$args['id']) }}"
                       role='button'>{!! trans('main.buttons.edit') !!}</a>
                    <button class="dropdown-item business-department-delete" type="button" role='button'
                            data-toggle="modal"
            ...
            <div class="col-12 px-0">
                <div class="d-flex">
                    <p class="MarksBeautifulFontColor mb-0">
                        <span><strong style="font-size: 16px;">@if($args['status'] == 1) @php trans('main.status.enabled') @endphp @else @php trans('main.status.disabled') @endphp @endif</strong></span>
                    </p>
                </div>
            </div>
        </div>
