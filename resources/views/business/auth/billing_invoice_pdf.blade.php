...
<div class="main-wrapper" style="max-width: 100%;">
    <div class="container" style="margin:0 auto; border:1px solid #000; padding: 10px 10px;">
        <table style="width: 100%;">
            <tbody>
            <tr>
                <td style="width: 15%; vertical-align: top; text-align: center; padding: 10px">
                    <img src="{{ asset('img/landing/cr-logo.png') }}" class="d-inline-block" alt="" width="130">
                </td>
                <td style="width: 40%;">
        ...
        @if ($invoice->country === 'Canada')
            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%; padding-top: 10px;">
                <tr>
