...
@section('content')
    ...
    <div class="container-fluid">
        <form id="business-candidate-form" autocomplete="off">
            <div class="row">
                <!-- left menu begin -->
                <div id="slide-out" class="sidebar_adaptive pl-0">
                ...
                <div class="flex-1 mx-auto pb-5 mt-1 mx-lg-3 content-main">
                    ...
                    <div class="d-flex flex-wrap mt-3">
                        ...
                        <div class="text-center col-lg-4 mx-auto- align-self-center switch-brand-block ml-auto pr-0">
                            <select name="switch-brand" class="form-control w-100"></select>
                        </div>
{{--                        <div class="text-center mx-auto- col-lg-4 align-self-center ml-auto pr-0">--}}
...
{{--                                <input id="crLink-CodeBitLyBusiness" type="text" name="" class="form-control border-top-right-0 border-bottom-right-0" value=""--}}
{{--                                       readonly>--}}
{{--                                <button style="width: 45vh;" type="button" class="btn btn-primary" data-clipboard-action="copy"--}}
{{--                                        data-clipboard-target="#crLink-CodeBitLyBusiness"--}}
{{--                                        id="clipboard-button">{!! trans('main.copy_career_page_link') !!}</button>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                    </div>
                        ...
                        <div class="col-md-12 businessApplicantsBlock" style="display: none">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mt-0 px-0">
                                        <div class="d-flex flex-lg-row flex-column justify-content-between col-12 px-0">
                                          <div class="d-flex flex-lg-row flex-column">
                                                ...
                                                <div class="d-inline-flex align-self-center" style="display: none !important;">
                                                ...
                                                <div class="align-self-center">
                                                    <a href="#"
                                                       ...
                                                       data-toggle="tooltip" title="Show/Hide Waves">
                                                        <span id="business-wave-candidate-count">0</span>
                                                        <strong>{!! trans('main.waves') !!}</strong>
                                                    </a>
                                                </div>
                                              <div class="align-self-center" style="padding-left: 25px;">
                                                  <button class="btn btn-outline-primary rounded d-flex" type="button" aria-expanded="false" data-toggle="modal" data-target="#candidateFilterModal" id="filters-modal" style="background-color: #fff; border:1px solid #4266ff; color:#4266ff;">
                                                      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 511.999 511.999" xml:space="preserve" height="20px" style="fill:#4266ff;" class="mr-2 align-self-center">
                                          ...
                                          <div class="d-flex justify-content-start flex-lg-row flex-column my-3 align-self-center">
                                                ...
                                                <div class="d-flex flex-lg-row flex-column px-3 pxa-0">
                                                    <div class="pl-0 d-flex align-self-center">
                                                        ...
                                                        <select class="form-control form-control-sm  border-0 bg-white" id="business-candidate-sort">
                                                            <option value="updated_date_desc" >{!! trans('main.sort.applicant_date_newest') !!}</option>
                                                            <option value="updated_date_asc" >{!! trans('main.sort.applicant_date_oldest') !!}</option>
                                                            <option value="name_asc" >{!! trans('main.sort.applicant_name_az') !!}</option>
                                                            <option value="name_desc" >{!! trans('main.sort.applicant_name_za') !!}</option>
                                                        </select>
                                                    </div>
                                                    <div class="align-self-center">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-12 business-candidate-list">
                                            <table class="table table-responsive display responsive no-wrap" id="business-candidate-list-table" style="width:100%; position: relative;">
                                                <thead>
                                                <tr>
                                                    <th scope="col"></th>
                                                </tr>
                                    ...
                                    <div class="px-3 hide" id="candidate-resume-send-button">
                                        ...
                                        <p class="text-center">
                                            <button type="button" name="req_update"
                                                    ...
                                                    id="candidate-send-request" data-candidate-id="" data-user-id="">
...
{{--                    </div>--}}
                            ...
                            <div class="modal-content">
                                                ...
                                                <div class="mr-3 d-flex align-self-center input-group" data-toggle="tooltip" title="{!! trans('fields.placeholder.note_the_candidate') !!}">
                                                  <input type="number" name="rating" class="form-control align-self-center" value="" min="1" max="10" style="width: 60px;" id="candidate-note-rating">
                                                    ...
                                                    <button type="button" class="btn btn-outline-primary align-self-center ml-2"
                                                            ...
                                                            data-user-id="" data-candidate-id="">{!! trans('main.buttons.add') !!}
                                                    </button>
                                                </div>
                                              </div>
                                            </div>
                                ...
                                <div class="modal-footer justify-content-center bg-light">
                                    <div class="col-md-4 mx-auto mt-3">
                                        <button class="btn btn-outline-primary btn-block" data-dismiss="modal">{!! trans('main.buttons.close') !!}</button>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center bg-light">
                                    <div class="col-md-4 mx-auto mt-0">
                                        <button type="button" class="btn btn-success btn-block" data-user-id="" data-candidate-id="" id="candidate-send-data-go">{!! trans('main.buttons.send') !!}</button>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="candidate-overview__block-buttons" style="display: none">
                        ...
                        <button type="button" class="btn btn-warning btn-sm ml-3 candidate_edit-show-form" data-candidate-id="" style="cursor:pointer;" data-toggle="modal" data-target="#editCandidate" data-dismiss="modal">
                            <span>
    ...
    <div class="modal fade bd-example-modal-lg" id="confirmation-subscription-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">What you will miss if you stay on freemium plan:</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="{!! trans('main.buttons.close') !!}">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row justify-content-center">
                            <div class="col-12">
                                ...
                                <p class="text-center">Confirmation Subscription</p>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="candidateFilterModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width: 750px;">
            <div class="modal-content">
                <div class="modal-header pt-0">
                    <h5 class="modal-title" id="exampleModalLabel">{!! trans('modals.title.candidate_filter') !!}</h5>
...
{{--    <script src="{{ asset('/js/app/business-applicants.js?v='.time()) }}"></script>--}}
    <script src="{{ asset('/js/app/business-ats.js?v='.time()) }}"></script>
        ...
        <script src="{{ asset('/js/app/business-applicants-new.js?v='.time()) }}"></script>
