                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pb-3 card border-top-0 border-left-0 border-right-0 rounded-0">
                        <h3 class="mx-auto mt-2 text-muted"
                            style="font-family: 'Open Sans', sans-serif; letter-spacing: -1px">{!! trans('pages.title.department.edit') !!}</h3>
                    </div>
                </div>
                <form id="business-department-form" autocomplete="off">
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <div class="btn-group text-center col-md-12 mt-3" data-toggle="buttons">
                                <label class="btn btn-outline-primary btn-block mb-0 py-3 w-100 d-flex flex-column justify-content-center align-items-center business-department-status"
                                       data-status="1">
                                    <input type="radio" name="visibility-options" id="option1"
                                           checked="">
                                ...
                                <label class="btn btn-outline-primary btn-block my-0 py-3 w-100 d-flex flex-column justify-content-center align-items-center business-department-status"
                                       data-status="0">
                                    <input type="radio" name="visibility-options" id="option2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12  pt-3">
                            ...
                            <input type="text" name="name" class="form-control [ multilanguage multilanguage-en ]" placeholder="{!! trans('fields.placeholder.department_name') !!}"  autocomplete="off">
                            <input type="text" name="name_fr" class="form-control [ multilanguage multilanguage-fr ] d-none" placeholder="{!! trans('fields.placeholder.department_name') !!}"  autocomplete="off">
                        </div>
...
{{--                                                </div>--}}
                        ...
                        <div class="col-md-3 mx-auto px-0 mt-4">
                            <button class="btn btn-primary btn-block" type="button" role="button"
                                    id="business-department-create">{!! trans('main.buttons.update_department') !!}
                            </button>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        ...
        $BusinessFunc.form_type = "department-edit";
