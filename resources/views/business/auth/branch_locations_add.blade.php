            ...
            <div class="col-xl-8 col-11 mx-auto pb-5 mt-2 bg-white rounded content-main">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pb-3 card border-top-0 border-left-0 border-right-0 rounded-0">
                        <h2 class="mx-auto mt-2 text-muted">{!! trans('pages.title.branch.add') !!}</h2>
                    </div>
                </div>
                ...
                <form id="business-location-form" autocomplete="off">
                    <div class="row">
                        <div class="col-md-6  pt-3">
                            ...
                            <select name="brand_id" class="form-control" id="location-select-brand"></select>
                        </div>
...
{{--                            <input type="text" name="name" class="form-control [ multilanguage multilanguage-en ]" placeholder="{!! trans('fields.placeholder.location_name') !!}"  autocomplete="disabled">--}}
{{--                            <input type="text" name="name_fr" class="form-control [ multilanguage multilanguage-fr ] d-none" placeholder="{!! trans('fields.placeholder.location_name') !!}"  autocomplete="disabled">--}}
{{--                        </div>--}}
...
{{--                        <p class="px-3 mb-2">{!! trans('fields.label.type_branch') !!}</p>--}}
{{--                        <div class="btn-group text-center col-md-12 mt-0 d-flex flex-column flex-lg-row"--}}
{{--                             data-toggle="buttons">--}}
{{--                            <label class="btn btn-outline-primary btn-block mb-0 py-3 w-100 d-flex flex-column justify-content-center align-items-center business-location-type active"--}}
{{--                                   data-type="location">--}}
...
{{--                                     style="enable-background:new 0 0 489.4 489.4; width: 25px; height: 25px;"--}}
{{--                                     xml:space="preserve">--}}
{{--											<g>--}}
{{--                                                <g>--}}
...
{{--                        </div>--}}
                        ...
                        <!-- <div class="col-md-10 mx-auto mt-5" id="map" style="height: 400px;">

                        <div class="col-md-12  pt-2">
                            <label>Enter address</label>
                            <input type="text" name="" class="form-control" placeholder="Type address">
                        </div>
...
{{--                                    </script>--}}
{{--                                @endforeach--}}
{{--                                <div class="btn-group col-md-12 amenities-list d-flex flex-column flex-lg-row" data-toggle="buttons"></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--									               </svg>--}}
{{--                                                </p>--}}
{{--                                                {!! trans('modals.title.add_department_location') !!}--}}
{{--                                            </a>--}}
{{--                                        </h4>--}}
{{--                                    </div>--}}
...
{{--                        </div>--}}
                        ...
                        <div class="col-md-3 mx-auto px-0 mt-4">
                            <button class="btn btn-primary btn-block" type="button" role="button"
                                    id="business-location-create">{!! trans('main.buttons.create_location') !!}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    {{--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8D3gJu3WgcTnXLfXzMfimvENQmbMadDU&callback=myMap"></script>--}}
