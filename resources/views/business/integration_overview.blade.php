    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-xl-8 mx-auto mt-3">
                ...
                <div class="col-12 p-3 border bg-white rounded">
                    ...
                    <div class="">
                        <div class="long_stick"
                             style=" height: 1px; width: 87.5%!important; background: #4E5C6E; margin:0 auto;"></div>
                        <div class="d-flex justify-content-between flex-column flex-lg-row text-center">
                            <div class="mb-2 flex-1">
                                <div class="stick"
                                     style="width: 1px; height: 30px; background: #4E5C6E; margin:0 auto;"></div>
                ...
                <div class="col-12 mt-3 px-0 border rounded">
                            ...
                            <div class="card-header bg-white text-center pt-3 pb-3" style="border-bottom:0;">
                                <div class="d-flex justify-content-start">
                                    <div class="col-12 col-lg-10 d-flex flex-column-reverse flex-md-row">
                                        <div>
                                            <div class="all_steps mx-auto">1/9</div>
                                        </div>
                                        <div class="col-11 flex-auto">
                                            <p class="mb-1 text-left rb_steps_info" style="font-size: 25px;">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                     enable-background="new 0 0 32 32" height="25px" id="Слой_1"
                                                     version="1.1" viewBox="0 0 32 32" width="25px" xml:space="preserve"
                                                    ...
                                                    <g/>
                                                    <g/></svg>
                                                <strong>{!! trans('integration.header.current_step') !!} </strong><i
                                                        id="current-step-title"></i>
                                            </p>
                                            <p class="mb-1 text-left">
                                                    <span class="ml-4 mxa-0 px-1 rounded"
                                                          style="background: rgba(0, 0, 0, 0.05); font-size: 12px;">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" height="15px"
                                                             version="1.1" viewBox="0 0 18 23" width="15px"
                                                             style="vertical-align: middle; margin-top: -3px; margin-right: 3px;fill:#7b7b7b;"><title></title><desc></desc><defs></defs><g
                                                                    fill="none" fill-rule="evenodd" id="Page-1"
                                                                    stroke="none" stroke-width="1"><g fill="#7b7b7b"
                                                                                                      id="Icons-Device"
                                                                                                      transform="translate(-87.000000, -209.000000)"><g
                                                                            id="timer"
                                                                            transform="translate(87.000000, 209.500000)"><path
                                            ...
                                            <p class="mb-1 text-left" style="font-size: 20px;">
                                                <strong>{!! trans('integration.header.next_step') !!}</strong> {!! trans('integration.header.fill_in_your') !!}
                                                <i>Job Preferences</i></p>
                                            <div class="progress">
