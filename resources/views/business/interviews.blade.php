  ...
  <div class="container-fluid">
      <div class="row">
          ...
          <div class="col-12 col-xl-8 mx-auto mt-3 content-main">
            <p class="text-center" id="no-interview-requests-yet" style="font-size: 20px; display: none;">{!! trans('pages.errors.b_interviews') !!}</p>
            ...
            <div class="help-how-to-start-block interview-requests-content__how-to-start" style="display:none;">
                <div class="col-12 bg-white rounded mt-4 p-3 pxa-0 pb-4">
                    <p class="h3 text-center font-response-20">
                        {!! trans('guides.b_interview.title') !!}
                        <button type="button"
                    ...
                    <div class="d-flex justify-content-center flex-lg-row flex-column mt-3">
                        <div class="text-center col-lg-6 col-12 mt-2">
                            ...
                            <p style="font-size: 18px; color:#9BA6B2;">
                                <strong>{!! trans('guides.b_interview.item_1_title') !!}</strong></p>
                            <p>{!! trans('guides.b_interview.item_1_text') !!}</p>
                    ...
                    <div class="d-flex justify-content-center flex-lg-row flex-column">
                        <div class="text-center col-lg-6 col-12">
                            ...
                            <p style="font-size: 18px; color:#9BA6B2;">
                                <strong>{!! trans('guides.b_interview.item_2_title') !!}</strong></p>
                            <p>{!! trans('guides.b_interview.item_2_text') !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center flex-lg-row flex-column">
                        <div class="text-center col-lg-4 col-12">
                            ...
                            <p style="font-size: 18px; color:#9BA6B2;">
                                <strong>{!! trans('guides.b_interview.item_3_title') !!}</strong></p>
                            <p>{!! trans('guides.b_interview.item_3_text') !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center flex-lg-row flex-column">
                        <div class="text-center col-lg-6 col-12">
                            ...
                            <p style="font-size: 18px; color:#9BA6B2;">
                                <strong>{!! trans('guides.b_interview.item_4_title') !!}</strong></p>
                            <p>{!! trans('guides.b_interview.item_4_text') !!}</p>
                        </div>
                    </div>
            ...
            <div id="interview-requests-content" style="display: none;">
              <!-- WHEN YOU GOT INTERVIEW -->
                <p class="mt-4 d-flex justify-content-between">
                    <strong>
                        {!! trans('pages.text.b_interviews.upcoming_interviews', ['count' => 0]) !!}
                    </strong>
                </p>
              ...
              <div class="text-center col-md-12 d-flex flex-column flex-lg-row flex-wrap my-3 px-0" id="interview-request-buttons">
                <button class="p-item btn btn-outline-primary rounded-0 flex-1 py-2 mt-0 releative" type="button" data-id="pending">
                    <span class="mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_0" x="0px" y="0px" viewBox="0 0 954.4 954.4" style="enable-background:new 0 0 512 512; vertical-align: middle;" xml:space="preserve" width="20px" height="20px">
                            <g>
                            <g>
                            <path d="M406.301,70.8h309.3c13.5,0,24.5-11,24.5-24.5v-0.5c0-13.5-11-24.5-24.5-24.5h-309.3c-13.5,0-24.5,11-24.5,24.5v0.5    C381.7,59.8,392.7,70.8,406.301,70.8z"></path>
                            <path d="M381.7,140.2c0,13.5,11,24.5,24.5,24.5h416c13.5,0,24.5-11,24.5-24.5v-0.5c0-13.5-11-24.5-24.5-24.5h-416    c-13.5,0-24.5,11-24.5,24.5V140.2L381.7,140.2z"></path>
                    ...
                    <p class="mb-0 mt-1" style="font-size:12px;" data-id="1">
                        <span style="font-weight: lighter;">{!! trans('main.tabs.b_interviews.pending') !!}</span>
                    </p>
                ...
                <button class="p-item btn btn-outline-primary rounded-0 flex-1 py-2 mt-0 releative" type="button" data-id="upcoming">
                    ...
                    <p class="mb-0 mt-1" style="font-size:12px;" data-id="1">
                        <span style="font-weight: lighter;">{!! trans('main.tabs.b_interviews.upcoming') !!}</span>
                    </p>
                    <span class="notification_dashboard_business" style="font-size: 12px !important; top: -8px; right: 3px; background-color: #dc3545; display: none;">0</span>
                </button>
                <button class="p-item btn btn-outline-primary rounded-0 flex-1 py-2 mt-0 releative" type="button" data-id="archived">
                    <span class="mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_0" x="0px" y="0px" viewBox="0 0 954.4 954.4" style="enable-background:new 0 0 512 512; vertical-align: middle;" xml:space="preserve" width="20px" height="20px">
                          ...
                          <p class="mb-0 mt-1" style="font-size:12px;" data-id="1">
                              <span style="font-weight: lighter;">{!! trans('main.tabs.b_interviews.history') !!}</span>
                          </p>
