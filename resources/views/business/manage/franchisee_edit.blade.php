                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pb-3 card border-top-0 border-left-0 border-right-0 rounded-0">
                        <h3 class="mx-auto mt-2 text-muted"
                            style="font-family: 'Open Sans', sans-serif; letter-spacing: -1px">{!! trans('pages.title.franchisee.edit') !!}</h3>
                    </div>
                </div>
...
{{--                                                </div>--}}
                        ...
                        <div class="col-md-3 mx-auto px-0 mt-4">
                            <button class="btn btn-primary btn-block" type="button" id="business-manager-create" role="button">{!! trans('main.buttons.update_franchisee') !!}</button>
                        </div>
                    </div>
                </form>
            </div>
