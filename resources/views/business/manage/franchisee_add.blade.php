...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- content block begin-->
            <div class="col-xl-8 col-11 mx-auto pb-5 mt-2 rounded bg-white content-main">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pb-3 card border-top-0 border-left-0 border-right-0 rounded-0">
                        <h3 class="mx-auto mt-2 text-muted">{!! trans('pages.title.franchisee.add') !!}</h3>
                    </div>
                </div>
                <form id="business-manager-form" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-md-12 pt-4" id="manager-role-permissions">
                            <div class="row">
                                <div class="col-md-8 mx-auto text-center">
                                    ...
                                    @foreach(\App\Business\Permit::where('type', \App\Business\Permit::FRANCHISEE_TYPE)->get() as $permit)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 offset-md-1">
                                                        <label class="switch mt-1">
                                                            <input type="checkbox" name="permits[]" checked value="{{ $permit->id }}" class="manager__permit-item">
                        ...
                        <div class="col-md-10 pb-0 card mx-auto mt-5 px-0"
                             style="box-shadow: 0 5px 23px rgba(0,0,0,0.2);" id="data-table-assigned-locations">
                                        ...
                                        <h4 class="panel-title my-0">
                                            <a data-toggle="collapse" href="#data-table-assigned-locations-collapse" data-parent="#accordion"
                                               ...
                                               style="text-decoration: none; color: #7b7b7b; font-size: 15px;font-weight: 400;" data-type-panel="location">
                                                ...
                                                {!! trans('modals.title.add_locations_franchisee') !!}</a>
                                        </h4>
                                    </div>
...
{{--                                                </div>--}}
                        ...
                        <div class="col-md-3 col-11 mx-auto px-0 mt-4">
                            <button class="btn btn-primary btn-block" type="button" id="business-manager-create" role="button">{!! trans('main.buttons.create_franchisee') !!}</button>
                        </div>
                    </div>
                </form>
            </div>
...
{{--            <script src="{{ asset('/js/app/business-items.js?v='.time()) }}"></script>--}}
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    ...
                    $BusinessFunc.form_type = "manager-create";
                    $BusinessFunc.manager_role = "franchisee";
