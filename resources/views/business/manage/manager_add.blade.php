            ...
            <div class="col-xl-8 col-11 mx-auto pb-5 mt-2 rounded bg-white content-main">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center pb-3 card border-top-0 border-left-0 border-right-0 rounded-0">
                        <h3 class="mx-auto mt-2 text-muted">{!! trans('pages.title.manager.add') !!}</h3>
                    </div>
                </div>
...
{{--                                                    </div>--}}
                        ...
                        @endif
                        <div class="col-md-12 col-11 mx-auto mt-4">
                            <div class="row">
                                <div class="col-md-4 mx-auto">
                                    <h4>Select a plan for manager</h4>
                                    <select name="paid_plan" id="paid-plan">
                        ...
                        <div class="col-md-3 col-11 mx-auto px-0 mt-4">
                                <button class="btn btn-primary btn-block" type="button" id="business-manager-create" role="button">{!! trans('main.buttons.create_manager') !!}</button>
                        </div> 
                    </div>
                </form>
            </div>
