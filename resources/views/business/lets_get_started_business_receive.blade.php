...
@section('content')
    ...
    <div class="container width-100-lg" style="margin-top: 60px;">
        <div class="col-12">
            ...
            <p class="text-center mb-5" style="font-size: 35px;font-weight: lighter;">{!! trans('lets_get_started.business.receive.title') !!}</p>
            <div class="d-flex justify-content-center flex-column-reverse flex-lg-row">
                <div class="border rounded bg-white p-3 mr-3 width-100-lg mb-3 blockResult" style="display: none;">
                    <p><strong>{!! trans('lets_get_started.business.receive.we_will_guide_you_with') !!}</strong></p>
                    ...
                    <p><img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none" class="mr-2">4</p>
                    <p><img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none" class="mr-2">5</p>
                    <p><img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none" class="mr-2">6</p>
                    <p><img src="{{ asset('img//sidebar/active.png') }}" style="margin-top: -3px; display: none" class="mr-2">7</p>--}}
                </div>
                <div class="width-100-lg col-lg-8 col-12 pxa-0 mb-3">
                    <div style="position: relative;">
                        ...
                        <div class="text-center ml-5 mxa-0" data-toggle="buttons">
                            <label class="btn btn-outline-primary connect col-12 btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_get_candidates_from_hiring_agencies') !!}">
                                <input type="checkbox" name="item4"  autocomplete="off" checked="" value="4">
                                <span class="d-flex">
                                    ...
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_get_candidates_from_hiring_agencies_q') !!}</p>
                                </span>
                            </label>

                            <label class="btn btn-outline-primary connect col-12 align-self-center btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_receive_in_store_resumes') !!}">
                                <input type="checkbox" name="item5"  autocomplete="off" checked=""  value="5">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_receive_in_store_resumes_q') !!}</p>
                                </span>
                            </label>
                            <label class="btn btn-outline-primary connect col-12 btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_posting_on_social_networks') !!}">
                                <input type="checkbox" name="item6"  autocomplete="off" checked="" value="6">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_posting_on_social_networks_q') !!}</p>
                                </span>
                            </label>

                            <label class="btn btn-outline-primary connect col-12 btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_post_jobs_job_bBoards_like') !!}">
                                <input type="checkbox" name="item7"  autocomplete="off" checked="" value="7">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_post_jobs_job_bBoards_like_q') !!}</p>
                                </span>
                            </label>
                            <label class="btn btn-outline-primary connect col-12 btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_have_an_ats') !!}">
                                <input type="checkbox" name="item8"  autocomplete="off" checked="" value="8">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_have_an_ats_q') !!}</p>
                                </span>
                            </label>

                            <label class="btn btn-outline-primary connect col-12 btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_receive_emails_via_an_email_like') !!}">
                                <input type="checkbox" name="item9"  autocomplete="off" checked="" value="9">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_receive_emails_via_an_email_like_q') !!}</p>
                                </span>
                            </label>
                            <label class="btn btn-outline-primary connect col-12 align-self-center btnChoiceLetsGetStartReceive" style="white-space: normal;" data-text="{!! trans('lets_get_started.business.receive.we_have_a_website_career_page') !!}">
                                <input type="checkbox" name="item10"  autocomplete="off" checked="" value="10">
                                <span class="d-flex">
                                    <div class="align-self-center mr-2">
                                    ...
                                    <img src="{{ asset('img//sidebar/active.png') }}" style="display: none;" class="mr-2 active_icon align-self-center">
                                    <p class="mb-0 align-self-center fw-lighter">{!! trans('lets_get_started.business.receive.we_have_a_website_career_page_q') !!}</p>
                                </span>
                            </label>
                        </div>
                        <div class="col-12 px-0 mt-3 d-flex">
                            <div class="mr-3 rounded" style="z-index: 1;">
                                <div style="border-radius: 5px; overflow: hidden;">
                                    <div style="width: 55px; height: 55px; margin: 0 auto;" id="avatar_hover">
                                        <img src="{{ asset('img/business-logo-small.png') }}" class="rounded menu-userpic" id="menu-userpic" style="position: relative; width: 55px; height: 55px; z-index: 1;" />
                                    </div>
                                </div>
                                <div>
                            ...
                            <p class="mb-0 align-self-center businessName" style="font-size: 20px;"></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 px-0 mt-4">
                <button id="btnLetsGo" class="btn btn-success btn-block col-lg-6 col-11 mx-auto">{!! trans('lets_get_started.business.buttons.lets_get_started') !!}</button>
            </div>
        </div>
    </div>
