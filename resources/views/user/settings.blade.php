...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="flex-1 col-12 col-lg-8 mx-auto mt-5 content-main">
                    ...
                    <div class="row pb-4 mt-3">
                            ...
                            <div class="col-md-12 mt-5">
                                ...
                                <div class="text-center mb-3">
                                    <div class="btn-group w-100" data-toggle="buttons">
                                        <label class="btn btn-outline-primary active mb-0 w-50 d-flex flex-column justify-content-center align-items-center tooltipOnOff">
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="col-12">
                                ...
                                <!-- <p class="mx-auto mt-2">{!! trans('main.language') !!}</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5">
                    ...
                    <p>
                        <input type="password" name="current_password" placeholder="{!! trans('fields.placeholder.enter_current_password') !!}" class="form-control">
                    </p>
                    <p>
                        <input type="password" name="new_password" placeholder="{!! trans('fields.placeholder.enter_new_password') !!}" class="form-control">
                    </p>
                    <p>
                        <input type="password" name="new_password_confirmation" placeholder="{!! trans('fields.placeholder.confirm_new_password') !!}" class="form-control">
                    </p>
                    <p>
