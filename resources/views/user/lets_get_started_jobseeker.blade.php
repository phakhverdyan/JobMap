@extends('layouts.main_user_empty')
...
<style type="text/css">
    ...
    <div class="container" style="margin-top: 70px;">
        <div class="col-12">
            ...
            <p class="text-center mb-3" style="font-size: 30px;">{!! trans('lets_get_started.user.how_cr_works_for_js') !!}</p>

            <div class="col-12 bg-white mt-4 mb-2 p-3 pxa-0 pb-4">
                <div>
                    <div class="text-center col-lg-8 mx-auto col-12 mt-2">
                        <p class="mb-3">
                        ...
                        <p class="mb-1" style="font-size: 25px; color:#9BA6B2;"><strong>{!! trans('lets_get_started.user.dont_upload_a_resume') !!}</strong></p>
                        <p style="font-size: 16px; color:#9BA6B2;">{!! trans('lets_get_started.user.we_will_help_you_build') !!}</p>
                        <p>{!! trans('lets_get_started.user.so_that_you_dont_need') !!}</p>
                    </div>
                ...
                <div class="d-flex justify-content-around flex-lg-row flex-column">
                    <div class="text-center col-lg-4 col-12" style="overflow: hidden;">
                        ...
                        <p style="font-size: 18px; color:#9BA6B2;"><strong>{!! trans('lets_get_started.user.apply_to_any_company') !!}</strong></p>
                        <p>{!! trans('lets_get_started.user.choose_any_location_and') !!}</p>
                    ...
                    <div class="text-center col-lg-4 col-12" style="overflow: hidden;">
                        ...
                        <p style="font-size: 18px; color:#9BA6B2;"><strong>{!! trans('lets_get_started.user.email_or_share_your_cr') !!}</strong></p>
                        <p>{!! trans('lets_get_started.user.instead_of_attaching_a') !!}</p>
                        <div class="mt-2 interview_stick" style="width: 1px; margin: 0 auto; background-color: #9BA6B2; height: 100%;"></div>
                    </div>
                    <div class="text-center col-lg-4 col-12" style="position: relative;">
                        ...
                        <p style="font-size: 18px; color:#9BA6B2;"><strong>{!! trans('lets_get_started.user.print_bring_your_cr') !!}</strong></p>
                        <p>{!! trans('lets_get_started.user.employers_will_scan_your') !!}</p>
                ...
                <div class="d-flex justify-content-center flex-lg-row flex-column">
                    <div class="text-center col-lg-4 col-12">
                        ...
                        <p style="font-size: 18px; color:#9BA6B2;"><strong>{!! trans('lets_get_started.user.receive_messages_and') !!}</strong></p>
                        <p class="mb-0">{!! trans('lets_get_started.user.you_will_receive_interview') !!}</p>
                    </div>
                </div>
            </div>

            <p class="mb-3">
                <a href="/user/dashboard" class="btn btn-primary btn-block col-lg-5 col-10 mx-auto">{!! trans('lets_get_started.user.lets_get_started') !!}</a>
            </p>
        </div>
    </div>
@endsection