                    ...
                    <div class="col-12 mt-3 wow animated fadeIn">
                        <div class="d-flex justify-content-center flex-lg-row flex-column">
                            <div class="col-12 col-lg-3 my-1">
                                <a href="{{ url('/') }}" role="button" class="btn btn-landing py-2 btn-block">
                            ...
                            <div class="col-12 col-lg-3 my-1">
                                <a href="{{ route('landing.teacher') }}" role="button" class="btn btn-landing py-2 btn-block {{ $type == 'teacher' ? 'active' : '' }}">
                            ...
                            <div class="col-12 col-lg-3 my-1">
                                <a href="{{ route('landing.director') }}" role="button" class="btn btn-landing py-2 btn-block {{ $type == 'director' ? 'active' : '' }}">
                ...
                <div class="col-lg-6 col-12 bg-white p-2 rounded wow fadeInRight">
                    <div class="text-center col-12 col-lg-12 mx-auto mt-2">
                        <div class="landing-blank-form">
                            <form action="{{route('academy.'.$type.'.signup')}}" id="landing-signup" method="post" autocomplete="off">
                                <div class="contact-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                                            <div class="mt-3">
                                                <div class="btn py-2 build_CR btn-block landing-blank-button">Continue</div>
