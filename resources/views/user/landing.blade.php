    ...
    <div class="container-fluid px-0">
        <div class="col-12 px-0">
            <div class="col-12 bg-white buttons_div">
                <span style="position: absolute; top: -25px; right: 60px; font-size: 16px;" class="d-flex login_landing">
                    <a class="cr-nav-text mr-5 align-self-center" href="#" id="show-sign-in" data-toggle="modal" data-target="#signInModal" style="color:#9c9c9c;">Login</a>
                    <a href="#" class="btn btn-warning py-2 px-3">Hiring?</a>
                </span>
                <div class="container">
                    <div class="col-12">
                        <p class="text-center mb-0 pb-3 mt-5">
                            <a href="{{ url('/') }}">
            ...
            <div class="col-12 pb-3 bg-white pt-2 px-0">
                <div class="container">
                    <p class="text-center mt-4 fw-300 font-38" style="font-size: 36px; letter-spacing: -1px;">Start your career with a <strong style="font-weight: 800;">powerful & free</strong> resume builder - <i>in the Cloud</i></p>
                    <div class="col-12 mt-3 wow animated fadeIn">
                        <div class="d-flex justify-content-between flex-lg-row flex-column">
                            <div class="row col-lg-6 col-12 mxa-auto">

                                <div class="col-12 my-1">
                                    <a href="{{ url('/') }}" role="button" class="btn btn-landing active py-2 btn-block">
                            ...
                            <div class="row col-lg-6 col-12 mxa-auto">
                                ...
                                <div class="col-12 my-1">
                                    <a href="{{ route('landing.teacher') }}" role="button" class="btn btn-landing py-2 btn-block">
                                ...
                                <div class="col-12 my-1">
                                    <a href="{{ route('landing.director') }}" role="button" class="btn btn-landing py-2 btn-block">
                    ...
                    <!-- <div class="text-center col-12 col-lg-12 mx-auto mt-5">
							<div class="d-flex justify-content-center flex-lg-row flex-column">
								<div class="col-lg-6 col-12 px-0">
									<div class="text-center"><img src="{{ asset('img/landing/laptop1.png') }}" class="pb-3" style="max-width: 100%; padding-top: 80px;"></div>
								</div>
								<div class="col-lg-6 col-12">
									<div class="mb-3 mx-auto text-left font-16" style="width: 267px;">
									  	<label class="switch mr-3 mb-0">
										  <input type="checkbox" checked>
										  <span class="slider round"></span>
										</label>
										<img src="/img/sidebar/active.png" class="mr-2">
										I'm looking for a job now.
									</div>
									<div class="mb-0 mx-auto text-left font-16" style="width: 267px;">
									  	<label class="switch mr-3 mb-0">
										  <input type="checkbox" checked>
										  <span class="slider round"></span>
										</label>
									...
									<div class="text-center col-12 col-lg-12 mx-auto mt-2">
										<div class="landing-blank-form">
				                            <form action="{{route('landing.signup')}}" id="landing-signup" method="post">
				                                <div class="contact-form">
				                                    <div class="row">
				                                        <div class="col-md-12 px-0 mx-auto">
				                                            <a class="modal-button google google-auth mt-0" href="javascript:void(0)" id="">
				                                                <img class="social-logo"
				                                                     src="{{ asset('/img/social/google.png') }}"/>
				                                    ...
				                                    <div class="row">
				                                        <div class="col-md-12 px-0 mx-auto">
				                                            <a class="modal-button facebook facebook-auth" href="javascript:void(0)" id="">
				                                                <img class="social-logo"
				                                                     src="{{ asset('/img/social/facebook.png') }}"/>
				                                                <span class="ml-3">Continue with Facebook </span>
				                                            </a>
				                                        </div>
				                                    </div>
				                                    <div class="row">
				                                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
				                                            {{csrf_field()}}
                            <input class="landing-blank-input mailField" type="text"
                                   placeholder="Enter a valid e-mail" name="email">
                        </div>
                    </div>
                    <div class="row nameFieldBox" style="display: none;">
                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                            <input name="first_name" class="landing-blank-input" type="text"
                                   placeholder="First name">
                        </div>
                    </div>
                    <div class="row nameFieldBox" style="display: none;">
                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                            <input name="last_name" class="landing-blank-input" type="text"
                    ...
                    <div class="row">
                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                            <div class="mt-3">
                                <button class="btn py-2 build_CR btn-block">Build my CloudResume</button>
                                <p class="my-2 text-muted font-14">Takes less than 3 minutes and it’s free.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12 bg-landing" style="padding: 50px 0;">
            <div class="container d-flex justify-content-end">
                <div class="col-lg-6 col-12 bg-white p-2 rounded wow fadeInRight">
                    <div class="mb-3 pt-3 mx-auto text-left font-16" style="width: 270px;">
                        <label class="switch mr-3 mb-0">
                            <input type="checkbox" checked>
                            <span class="slider round"></span>
                        </label>
                        <img src="{{ asset('/img/sidebar/active.png') }}" class="mr-1">
                        I'm looking for a job <strong>now.</strong>
                    </div>
                    <div class="mb-0 mx-auto text-left font-16" style="width: 270px;">
                        <label class="switch mr-3 mb-0">
                            <input type="checkbox" checked>
                            <span class="slider round"></span>
                        </label>
                        <img src="{{ asset('/img/sidebar/active.png') }}" class="mr-1">
                        This is my <strong>first resume.</strong>
                    </div>
                    <div class="text-center col-12 col-lg-12 mx-auto mt-2">
                        <div class="landing-blank-form">
                            <form action="{{route('landing.signup')}}" id="landing-signup" method="post" autocomplete="off">
                                <div class="contact-form">
                                    {{-- <div class="row">
                                        <div class="col-md-12 px-0 mx-auto">
                                            <a class="modal-button google google-auth mt-0" href="javascript:void(0)" id="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                                            {{csrf_field()}}
                                            <input class="landing-blank-input mailField" type="text"
                                                   placeholder="Enter a valid e-mail" name="email"  autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row nameFieldBox" style="display: none;">
                                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 px-0 col-sm-12 mx-auto">
                                            <div class="mt-3">
                                                <div class="btn py-2 build_CR btn-block landing-blank-button">Build my CloudResume</div>
                                                <p class="my-2 text-muted font-14">Takes less than <i>3 minutes</i> and it’s <strong>free</strong></p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-12 py-5 " style="background: #3b77d7; color:#fff;">
            <div class="container">
                <div class="col-12">
                    <p class="text-center mt-0 fw-300 font-38">Employers will be <span style="font-weight: 800;">glad</span> you have one</p>
        ...
        <div class="col-12 py-3 bg-landing-students">
            <div class="container d-flex align-items-center" style="min-height: 400px;">
                <div class="col-12 p-2 rounded wow animated fadeInDown" style="background-color: rgba(0,0,0,0.3);">
                    <p style="color:#fff; letter-spacing: -1px; font-weight: lighter; font-size: 36px;" class="mb-0 font-38 text-center">The <strong>perfect</strong> online resume builder with a <i>step by step</i> creation assistant</p>
                </div>
            </div>
        </div>
        <div class="col-12 py-3" style="background: #fff; color:#3b77d7;">
            <div class="container">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-center justify-content-md-around flex-md-row flex-column mt-5">
                        <div class="text-center col-md-4 col-12 my-2 wow fadeInLeft">
                            <p>
                        ...
                        <div class="text-center col-md-4 col-12 my-2 wow fadeInRight">
                            <p>
...
<!--
    <div class="container-fluid user-landing">
        <div class="row">
            <div class="col-12">
                <div class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active"
                             style="height: 760px; background-image: url('{{ asset('/img/landing/user-landing-bg.jpg') }}')"></div>
                ...
                <div class="row section-content" style="height: 760px;">
                    <div class="col-md-6 col-lg-7">
                        <div class="landing-header col-10 row white-section offset-2">
                            <div class="row">
                                <p class="main-title-white">Build your CloudResume</p>
                            </div>
                            <div class="row">
                                <p class="sub-title-white">Employers will see updates <span
                                            class="strong"> instantly </span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-sm-12">
                        <div class="landing-blank animated fadeInRight">
                            <div class="arrow"></div>
                            <div class="landing-blank-form">
                                <form action="{{route('landing.signup')}}" id="landing-signup" method="post">
                                    <div class="contact-form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 col-sm-12 mx-auto">
                                                <div class="landing-blank-button">
                                                    <img class="landing-blank-logo-white"
                                                         src="{{ asset('/img/white-cr-logo.png') }}"/>
                                                    <img class="landing-blank-logo-orange"
                                                         src="{{ asset('/img/orange-cr-logo.png') }}"/>
                                                    <div class="landing-blank-content">
                                                        <p>Start my Resume</p>
                                                        <p>Modify it from anywhere, anytime</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row section-content white-section">
                    <div class="col-12">
                        <div class="row mb-5">
                            <div class="col-12">
                                <img style="display: block;" class="mx-auto mt-4 mb-2"
                                     src="{{ asset('/img/landing/clock-img.png') }}">
                                <p class="main-title-blue text-center">6 minutes</p>
                                <p class="simple-text text-center">The avarage time it takes to build a CloudResume</p>
                            </div>
                        </div>
                        <div class="row ml-5 mr-5">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <p class="sub-title-blue">
                                    Employers will see your updates in real time, without resending your resume
                                </p>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-9 col-sm-12 mx-auto">
                                        <img style="display: block; width: 100%"
                                             src="{{ asset('/img/landing/landing-img-1.png') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        $('.bg-landing').parallax({
            imageSrc: '/img/landing/woman-cr.png',
            positionY: '150px'
        });

        $('.bg-landing-students').parallax({
            imageSrc: '/img/landing/cr-students.png'
        });
    </script>
@endsection
