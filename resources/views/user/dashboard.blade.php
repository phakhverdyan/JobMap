...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="flex-1 col-12 col-lg-8 mx-auto content-main">

                <div class="col-md-11 mb-3 mx-auto mt-5 py-3 bg-white rounded">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-12 text-center d-lg-block d-none">
                        <div class="mt-1 py-5 ">
                            <div class="row mb-3 justify-content-md-center">
                                <div class="col-12 col-lg-12 col-xl-11 ml-1 mr-1 mb-3 mx-auto">
                                    <div class="rounded bg-white p-5">
                                        ...
                                        <div class="card-block">
                                            <div class="row justify-content-md-center">
                                                <div class="btn-group mb-3 col-md-12 flex-column flex-md-row"
                                                     role="group" aria-label="Basic example">
                                                    <a href="{!! url('/user/interviews') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-2 mx-auto mt-0 col-12">
                                                        <span class="notification_dashboard_user realtime__count-of-upcoming-interviews"
                                                              style="background: #ffc107; display: none"></span>
                                            ...
                                            <div class="row justify-content-md-center">
                                                <div class="btn-group mb-3 col-md-12 flex-column flex-md-row"
                                                     role="group" aria-label="Basic example">
                                                    <a href="{!! url('/user/resume/create') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-2 mx-auto mt-0 col-12 col-md-4">
                                                        <span class="notification_dashboard_user countResumeBuilder"
                                                              style="background: #ffc107;display: none"></span>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             id="Layer_1" x="0px" y="0px" viewBox="0 0 512.001 512.001"
                                                             style="enable-background:new 0 0 512.001 512.001; width: 50px;"
                                                             xml:space="preserve" width="50px" height="50px">
														<g>
                                                            <g>
                                                        ...
                                                        <div class="dash_a_text">
                                                            <p class="lead mb-1">{!! trans('main.resume_builder') !!}</p>
                                                            <p class="lastsee-view-sent"
                                                               style="font-size: 14px;">
                                                                {!! trans('main.last_update') !!} <br>
                                                                <strong class="lastUpdate"></strong></p>
                                                        </div>
                                                    </a>

                                                    <a href="{!! url('/user/resume/view') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-2 mx-auto mt-0 col-12 col-md-4">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                        ...
                                                        <div>
                                                            <p class="lead mb-1">{!! trans('main.resume_overview') !!}</p>
                                                            <p class="lastsee-view-sent"
                                                               style="font-size: 14px;">
                                                                {!! trans('main.last_viewed') !!} <br>
                                                                <strong class="lastViewed"></strong></p>
                                                        </div>
                                                    </a>

                                                    <a href="{!! url('/user/resume/sent') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-2 mx-auto mt-0 col-12 col-md-4">
                                                        <span class="notification_dashboard_user countSentResumes"
                                                              style="right: 30px; color: #ffffff; display: none"></span>
                                                        <span class="notification_dashboard_user countSentResumesAsk"
                                                              style="display: none"></span>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             id="Capa_1" x="0px" y="0px" viewBox="0 0 490.282 490.282"
                                                             style="enable-background:new 0 0 490.282 490.282; width: 50px;"
                                                        ...
                                                        <div>
                                                            <p class="lead mb-1">{!! trans('main.sent_resumes') !!}</p>
                                                            <p class="lastsee-view-sent"
                                                               style="font-size: 14px;">
                                                                {!! trans('main.last_sent') !!} <br>
                                                                <strong class="lastSent"></strong></p>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="row justify-content-md-center">
                                                <div class="btn-group mb-3 col-md-12 flex-column flex-md-row"
                                                     role="group" aria-label="Basic example">
                                                    <a href="{!! url('/user/messages') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-3 mx-auto mt-0 col-12 col-md-4">
                                                        <span class="notification_dashboard_user realtime__total-count-of-unread-chats-with-unread-messages"
                                                              style="display: none;"></span>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                                                    ...
                                                    <a href="{!! url('/user/references') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-3 mx-auto mt-0 mt-0 col-12 col-md-4">
                                                        <span class="notification_dashboard_user countReferences"
                                                              style="display: none"></span>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             id="Layer_1" x="0px" y="0px" viewBox="0 0 512.001 512.001"
                                                             ...
                                                             xml:space="preserve" width="50px" height="50px">
												                                   <g>
                                                        <g>
                                                            <path d="M175.839,404.814c-4.142,0-7.5,3.358-7.5,7.5v32.064c0,4.142,3.358,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5v-32.064    C183.339,408.172,179.981,404.814,175.839,404.814z"/>
                                                        </g>
                                                    </g>
                                                            <g>
                                                                <g>
                                                                    <path d="M336.161,404.814c-4.142,0-7.5,3.358-7.5,7.5v32.064c0,4.142,3.358,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5v-32.064    C343.661,408.172,340.303,404.814,336.161,404.814z"/>
                                                                </g>
                                                            </g>
                                                            <g>
                                                                <g>
                                                                    <path d="M115.063,245.284c-17.416-8.708-50.069-8.808-51.451-8.808c-4.141,0-7.498,3.356-7.499,7.498    c-0.001,4.141,3.355,7.5,7.497,7.502c8.438,0.005,32.923,1.313,44.745,7.224c1.077,0.539,2.221,0.793,3.348,0.793    c2.751,0,5.4-1.52,6.714-4.147C120.27,251.641,118.768,247.136,115.063,245.284z"/>
                                                                </g>
                                                            </g>
                                                            <g>
                                                                <g>
                                                                    <path d="M39.564,388.782c-4.142,0-7.5,3.358-7.5,7.5v48.097c0,4.142,3.358,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5v-48.097    C47.064,392.141,43.707,388.782,39.564,388.782z"/>
                                                                </g>
                                                            </g>
                                                            <g>
                                                                <g>
                                                            ...
                                                            <g>
                                                                <g>
                                                                    <path d="M472.436,398.692c-4.142,0-7.5,3.358-7.5,7.5v38.187c0,4.142,3.358,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5v-38.187    C479.936,402.05,476.578,398.692,472.436,398.692z"/>
                                                                </g>
                                                            </g>
												                                  </svg>
                                                        <div>
                                                            <p class="lead">{!! trans('main.references') !!}</p>
                                                        </div>
                                                    </a>

                                                    <a href="{!! url('/user/settings') !!}" role="button"
                                                       class="btn btn-outline-primary btn-block pt-4 pb-3 mx-auto mt-0 col-12 col-md-4">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                             id="Capa_1" x="0px" y="0px" viewBox="0 0 478.703 478.703"
                                                             style="enable-background:new 0 0 478.703 478.703; width: 50px;"
                                                             xml:space="preserve" width="50px" height="50px"><g>
                                                                <g>
                                                                    <g>
                ...
                <div class="col-md-10 mx-auto col-12 px-1 mb-3 d-lg-none d-block w-100 bg-white rounded dashboard_mobile_sidebar" style="position: relative;">
                  ...
                  <div class="relative disabled-hover">
                      <div class="d-flex justify-content-between justify-content-end mb-0 px-3" style="box-shadow: inset 0 1px 1px rgba(0,0,0,0.075); border: 1px solid rgba(78,92,110,.1); background-color: #f4f4f4;">
                          ...
                          <div class="switcher_to_business business-list business-list-outclick bg-white rounded border-top-right-0" style="list-style: none;">
                  ...
                  <div class="show-no-businesses" style="display: none">
                    ...
                    <div class="d-flex" style="margin:20px 0 40px 0;">
                    ...
                    <div class="d-flex mb-3 px-3 block-checkbox">
                    ...
                    <ul class="nav-side-menu_mobile">
                      ...
                      <li>
                          ...
                          <span class="notification animated countResumeBuilder" style="background: #dc3545;display: none"></span>
                      </li>
                      <li>
                      ...
                      <li class="relative">
                          <a href="{!! url('/user/interviews') !!}">
                                      ...
                                      <span class="notification realtime__count-of-upcoming-interviews" style="background-color: #28a745; display: none;">1</span>
                                  </li>
                                  <li>
                              ...
                              <span class="countSentResumes ml-2 px-1 rounded"
                      ...
                      <li>
                          ...
                          <span class="notification countReferences" style="display: none"></span>
                      </li>
                      <li>
                          <a href="{{ url('/map') }}">
                                          <span style="padding-left: 11px; padding-right: 20px;">
                              ...
                              <span>{!! trans('sidebar.menu.explore_jobs') !!}</span>
                          </a>
                          <span class="notification countReferences" style="display: none"></span>
                      </li>


                      <div class="btn-group col-12 px-0 formSendFeedback" role="group" aria-label="Basic example" style="margin: 30px 0;">
                      ...
                      <li class="no-hover">
                          <a style="width: 100%; margin-left: 0;">
                              <img src="{{ asset('img/JobMap_white.svg') }}" height="60" style="
                                          display: block;
                                          text-align: center;
                                          margin: auto;
                                          margin-top: 50px;
