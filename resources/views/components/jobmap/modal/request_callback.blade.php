...
<div class="modal fade" id="requestCallbackModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="mt-3">
                    ...
                    <p class="text-center">{!! trans('landing.form.request_a_callback') !!}</p>
                    <p><input type="email" name="email" class="form-control" placeholder="{!! trans('landing.form.email') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="contact_name" class="form-control" placeholder="{!! trans('landing.form.contact_name') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="employer_name" class="form-control" placeholder="{!! trans('landing.form.employer_name') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="employer_number" class="form-control" placeholder="{!! trans('landing.form.number_of_employees') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="location_number" class="form-control" placeholder="{!! trans('landing.form.number_of_location') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="phone" class="form-control" placeholder="{!! trans('landing.form.phone_number') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="extension" class="form-control" placeholder="{!! trans('landing.form.extension') !!}"  autocomplete="off"></p>
                    <p><textarea name="message" class="form-control" rows="2" placeholder="{!! trans('landing.form.message_optional') !!}"></textarea></p>
                    <p><input type="text" name="time" class="form-control" placeholder="{!! trans('landing.form.time_to_call_back') !!}"  autocomplete="off"></p>
                    <p><input type="text" name="country" class="form-control" placeholder="{!! trans('landing.form.country') !!}"  autocomplete="off"></p>
                </div>
                <p class="text-center mb-0"><button id="sendRequestCallback" type="button" class="btn btn-primary">{!! trans('landing.form.call_me_back') !!}</button></p>
            </div>
        </div>
    </div>
</div>
