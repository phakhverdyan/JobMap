                    ...
                    <form class="my-5 py-5 bg-white rounded" action="" method="post" id="sign-up-user-form" autocomplete="off">
                        <div class="block_business-logo-medium">
                            <p class="text-center mt-0">
                                <img class="border" src="{{ isset($data) && isset($data->business) ? $data->business->picture : '' }}" style="width: 80px; height: 80px; background-color: transparent; border-radius: 10px; box-shadow: 0 4px 10px 0 rgba(0, 0, 0, 0.14), 0 1px 2px 0 rgba(0, 0, 0, 0.12), 0 3px 1px -2px rgba(0, 0, 0, 0.2);">
                            </p>
                        </div>
