<div class="input-group relative px-4">
    <div class="input-group-btn border w-100">
        <a href="javascript:void(0)" id="business-switcher" data-business="" class="switch-to-business profile-switcher btn btn-outline-success clear-mg btn-sm text-left" title="View your business menu" style="border-radius: 5px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
