        ...
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal"
                        data-target="#editModalInterest" data-id="{{ $args['id'] }}"
                        data-item-action="resume-interest-edit">
                ...
                <button type="button" class="btn btn-link p-0" data-item-action="resume-interest-delete"
                        data-id="{{ $args['id'] }}">
                                    <span class="d-flex align-items-center justify-content-center">
