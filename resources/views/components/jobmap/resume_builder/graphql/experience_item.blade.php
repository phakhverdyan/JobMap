<div class="col-12 item-row" data-id="{{ $args['id'] }}">
    <div class="card mb-3 text-left">
        <div class="card-header d-flex justify-content-between">
            <h6 class="h6 mb-0 text-grey">{{ date('F',strtotime($args['date_from'])) }} {{ date('Y',strtotime($args['date_from'])) }}
                -
            ...
            <div class="d-flex align-items-center">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal"
                        data-target="#editModalExperience" data-id="{{ $args['id'] }}"
                        data-item-action="resume-experience-edit">
                ...
                <button type="button" class="btn btn-link p-0"
                        data-item-action="resume-experience-delete" data-id="{{ $args['id'] }}">
                                    <span class="d-flex align-items-center justify-content-center">
