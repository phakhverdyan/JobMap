    ...
    <div class="card text-left mb-3">
        <div class="card-header d-flex">
            <div class="d-flex align-items-center ml-auto">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal" data-target="#editModalLanguage"
                        data-id="{{ $args['id'] }}"
                        data-item-action="resume-language-edit">
        ...
        <div class="card-body d-flex justify-content-between align-items-baseline">
            <p class="mb-0 text-grey" style="flex: 1">{{ $args['title'] }}</p>
