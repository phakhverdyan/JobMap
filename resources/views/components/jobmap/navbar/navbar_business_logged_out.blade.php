<nav class="navbar navbar-light cr-navbar px-1 px-md-3" id="navbar" style="padding: 0 1rem; background-color: #fff;">
    <div class="d-flex justify-content-between col-12 px-0">
        <div class="align-self-center d-flex">
            ...
            <a class="cr-nav-text mx-2 align-self-center" href="#" id="show-sign-in" data-toggle="modal" data-target="#signInModal" style="color: #4E5C6E;">
                {!! trans('main.buttons.login') !!}
            </a>
            <div style="background-color: #eee; width: 1px; height: 55px;" class="align-self-center"></div>
            <a href="{{ url('/user/resume/create') }}" class="cr-nav-text mx-3 align-self-center d-lg-none d-block"
            ...
            <a href="{{ url('/user/resume/create') }}" class=" mx-3 align-self-center d-lg-block d-none"
               style="margin-top:0!important;" data-toggle="tooltip" data-placement="bottom"
               title="{!! trans('main.navbar.create_my_JobMap') !!}">
        ...
        <div class="align-self-center">
            <a href="{{ url('/') }}" class="cardinal_links align-self-center d-md-flex d-none"><strong>Hiring?</strong></a>
        </div>
        <div class="align-self-center">
            <ul class="navbar-nav flex-row ml-auto cr-nav-items" id="auth-no-login" style="height: 40px;vertical-align: middle;box-sizing: border-box; padding-top: 10px;">
                <li class="nav-item d-xl-block d-none">
                    <a class="btn btn-primary px-4" href="{!! url('/') !!}" style="margin-top: -5px; padding: 5px 10px; font-size: 15px;">Classic</a>
                </li>
