<div class="col-12 mb-1 item-row" data-id="{{ $args['id'] }}">
    <div class="text-left mb-3">
        <div class="d-flex justify-content-between">
            <h6 class="h6 mb-0 text-grey">{{ $args['title'] }}</h6>
            <div class="d-flex align-items-center">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal" data-target="#editModalSkill"
                        data-id="{{ $args['id'] }}"
                        data-item-action="resume-skill-edit">
                ...
                <button type="button" class="btn btn-link p-0" data-item-action="resume-skill-delete"
                        data-id="{{ $args['id'] }}">
                                    <span class="d-flex align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-between align-items-baseline">
            <pre class="my-0 text-grey" style="flex: 1">{{ $args['description'] }}</pre>
            <div class="bg-light rounded border" style="width:130px; height: 12px">
                <div class="bg-primary rounded" style="width: {{ $args['level'] }}%; height: 100%; opacity: 0.8"></div>
            </div>
        </div>
    </div>
</div>