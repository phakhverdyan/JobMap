<div class="col-12 pb-3 pt-3 form-tab-content" data-builder-step="linkto_careerpage">
    <div class="row justify-content-center">
        <div class="col-11">
            <div class="form-group mb-5">
                <p class="mb-5 text text-center fw-lighter" style="font-size:30px;">{!! trans('integration.career.title') !!}</p>
                <p class="text-center mb-0"><strong>{!! trans('main.integration_time') !!}</strong></p>
                <p class="text-center">{!! trans('integration.career.time') !!}</p>
                <div class="d-flex flex-column flex-lg-row justify-content-between mt-5">
                	<div class="text-center col-lg-4 col-12">
                		...
                		<p><strong>{!! trans('integration.career.link_1') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-4 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.career.link_2') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-4 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.career.link_3') !!}</strong></p>
                	</div>
                </div>

                <p class="mt-5"><strong>{!! trans('integration.career.text_box_1.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                	<li>{!! trans('integration.career.text_box_1.text') !!}</li>
                </ul>

                <div class="d-flex flex-column-reverse">
                	<div class="col-12 pxa-0 pl-0">
                		<p class="mt-3"><strong>{!! trans('integration.career.text_box_2.title') !!}</strong></p>
		                <ul style="list-style: none;" class="pxa-0">
                            {!! trans('integration.career.text_box_2.text', [
                	...
                	<div class="col-12 pxa-0 mt-5">
                		<div class="border rounded p-3">
                			<p class="text-center mb-0">
                                {!! trans('integration.career.hint') !!}
                			</p>	
                		</div>
                	</div>
                </div>

                <p class="mt-5"><strong>{!! trans('integration.career.text_box_3.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                    {!! trans('integration.career.text_box_3.text') !!}
                </ul>
