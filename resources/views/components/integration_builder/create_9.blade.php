<div class="col-12 pb-3 pt-3 form-tab-content" data-builder-step="job_posting">
    <div class="row justify-content-center">
        <div class="col-11">
            <div class="form-group mb-5">
                {!! trans('integration.posting.title') !!}
                <p class="text-center mb-0"><strong>{!! trans('main.integration_time') !!}</strong></p>
                <p class="text-center">{!! trans('integration.posting.time') !!}</p>
                <div class="d-flex flex-column flex-lg-row justify-content-between mt-5">
                	<div class="text-center col-lg-4 col-12">
                		<p>
                			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 57.502 57.502" style="enable-background:new 0 0 57.502 57.502; fill:#7b7b7b;" xml:space="preserve" width="50px" height="50px"><g><g>
                		...
                		<p><strong>{!! trans('integration.posting.link_1') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-4 col-12">
                		<p>
                			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512.019 512.019" style="enable-background:new 0 0 512 512; fill:#7b7b7b;" xml:space="preserve" width="50px" height="50px">
                                <g><g>
                                    <g>
                		...
                		<p><strong>{!! trans('integration.posting.link_2') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-4 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.posting.link_3') !!}</strong></p>
                	</div>
                </div>

                <p class="mt-5"><strong>{!! trans('integration.posting.text_box_1.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                	<li>{!! trans('integration.posting.text_box_1.text') !!}</li>
                </ul>

                <div class="d-flex flex-column-reverse">
                	<div class="col-12 pxa-0 pl-0">
                		<p class="mt-3"><strong>{!! trans('integration.posting.text_box_2.title') !!}</strong></p>
		                <ul style="list-style: none;" class="pxa-0">
                            {!! trans('integration.posting.text_box_2.text', [
                	...
                	<div class="col-12 pxa-0 mt-5">
                		<div class="border rounded p-3">
                			<p class="text-center mb-0">
                                {!! trans('integration.posting.hint') !!}
                			</p>	
                		</div>
                	</div>
                </div>

                <p class="mt-5"><strong>{!! trans('integration.posting.text_box_3.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                    {!! trans('integration.posting.text_box_3.text') !!}
                </ul>
