<div class="col-12 pb-3 pt-3 form-tab-content resume-builder-step" data-builder-step="CREmail">
    <div class="row justify-content-center" id="user-basic-info">
        <div class="col-11">
            <div class="form-group mb-5">
                <p class="mb-5 text text-center fw-lighter" style="font-size:30px;">{!! trans('integration.cr_email.title') !!}</p>
                <p class="text-center mb-0"><strong>{!! trans('main.integration_time') !!}</strong></p>
                <p class="text-center">{!! trans('integration.cr_email.time') !!}</p>
                <div class="d-flex flex-column flex-lg-row justify-content-between mt-5">
                	<div class="text-center col-lg-3 col-12">
                		<p>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; fill:#7b7b7b;" xml:space="preserve" width="50px" height="50px">
                                <g>
                                    <g>
                		...
                		<p><strong>{!! trans('integration.cr_email.link_1') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-3 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.cr_email.link_2') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-3 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.cr_email.link_3') !!}</strong></p>
                	</div>
                	<div class="text-center col-lg-3 col-12">
                		<p>
                		...
                		<p><strong>{!! trans('integration.cr_email.link_4') !!}</strong></p>
                	</div>
                </div>

                <p class="mt-5"><strong>{!! trans('integration.cr_email.text_box_1.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                	<li>{!! trans('integration.cr_email.text_box_1.text') !!}</li>
                </ul>

                <div class="d-flex flex-column-reverse">
                	<div class="col-12 pxa-0 pl-0">
                		<p class="mt-3"><strong>{!! trans('integration.cr_email.text_box_2.title') !!}</strong></p>
		                <ul style="list-style: none;" class="pxa-0">
                            {!! trans('integration.cr_email.text_box_2.text', [
                	...
                	<div class="col-12 pxa-0 mt-5">
                		<div class="border rounded p-3">
                			<p class="text-center mb-0">
                                {!! trans('integration.cr_email.hint') !!}
                			</p>	
                		</div>
                	</div>
                ...
                <p class="mt-5"><strong>{!! trans('integration.cr_email.text_box_3.title') !!}</strong></p>
                <ul style="list-style: none;" class="pxa-0">
                    {!! trans('integration.cr_email.text_box_3.text') !!}
                </ul>

                <p class="text-center">
                	<button class="btn btn-primary">{!! trans('main.buttons.grab') !!}</button>
                </p>
