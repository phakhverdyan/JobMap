<div class="col-12 pb-3 pt-5 form-tab-content resume-builder-step" data-builder-step="Education">
    <div class="row justify-content-center">
        <div class="col-11">
            <div class="row px-3 mb-3">
                <h5 class="h5 mb-3 text w-100 light-grey text-center">{!! trans('resume_builder.education.display_education') !!}</h5>
                <div class="btn-group w-100" data-toggle="buttons">
                    <label class="btn btn-outline-primary mb-0 py-4 w-50 d-flex flex-column justify-content-center align-items-center">
                        <input name="not_education" id="not-education-no" type="radio" value="2">
                        <span>
                    ...
                    <label class="btn  btn-outline-primary mb-0 py-4 w-50 d-flex flex-column justify-content-center align-items-center">
                        <input name="not_education" id="not-education-yes" type="radio" value="1">
                        <span>
                            <svg class="mr-2" enable-background="new 0 0 48 48" height="40px" width="40px" id="Layer_1" version="1.1" viewBox="0 0 48 48" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle;     margin-top: -3px; width: 20px; height: 20px;">
                ...
                <p class="text-center w-100">{!! trans('resume_builder.education.display_education_sub_text') !!}</p>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="mb-4">
                        <button type="button" class="btn btn-lg btn-outline-primary w-100 p-4" data-toggle="modal"
                            ...
                            {!! trans('resume_builder.education.add_btn') !!}
                        </button>
                    </div>
                </div>
            </div>
            <div class="row items-list" data-type-item="resume-education">
                <div class="col-12 hide" id="resume-not-education">
                    <div class="border bg-light rounded p-2">
                        <p class="mb-0" style="opacity: 0.8;">{!! trans('resume_builder.education.no_items') !!}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="exampleModalLabel">{!! trans('modals.title.education') !!}</h5>
                                        ...
                                        <div class="col-12 text-left">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="school_name"
                                                       placeholder="{!! trans('fields.placeholder.school_name') !!}">
                                            </div>
                                            <div class="form-group mb-2">
                                                ...
                                                <span class="input-group-addon" id="education-addon1"><i
                                                    ...
                                                    <input type="text" class="form-control" placeholder="{!! trans('fields.placeholder.location') !!}"
                                                           name="city"
                                                           id="education-location">
                                                    <span class="input-group-btn border-0">
                                            <button class="btn mx-0" type="button" id="education-location-clear"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group text-left mb-3">
                                                <label class="custom-control custom-checkbox mb-0">
                                                    ...
                                                    <span class="custom-control-description">{!! trans('fields.label.currently_study') !!}</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group mb-0">
                                                <label>{!! trans('fields.label.degree') !!}</label>
                                                {{--<input type="text" class="form-control"
                                                       placeholder="{!! trans('fields.placeholder.degree') !!}" name="degree">--}}
                                                <div id="education-degree"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group mb-0">
                                                <label>{!! trans('fields.label.study') !!}</label>
                                                {{--<input type="text" class="form-control"
                                                       placeholder="{!! trans('fields.placeholder.study') !!}" name="study">--}}
                                                <div id="education-study"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                <label>{!! trans('fields.label.activities') !!}</label>
                                                <textarea maxlength="1000" class="form-control" rows="3"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                <label>{!! trans('fields.label.achievement_title') !!}</label>
                                                <input type="text" class="form-control" placeholder="{!! trans('fields.placeholder.achievement_title') !!}"
                                                       name="achievement_title">
                                            </div>
                                            <div class="form-group mb-0">
                                                <label>{!! trans('fields.label.achievement_description') !!}n</label>
                                                <textarea maxlength="1000" class="form-control" rows="3"
                                                          name="achievement_description"></textarea>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="saveEditModalEducation" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{!! trans('modals.title.education') !!}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="{!! trans('main.buttons.close') !!}">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
