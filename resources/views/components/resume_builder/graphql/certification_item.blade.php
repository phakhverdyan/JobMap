        ...
        <div class="d-flex align-items-center justify-content-start">
            <div class="d-flex align-items-center mr-3">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal"
                        data-target="#editModalCertification" data-id="{{ $args['id'] }}"
                        data-item-action="resume-certification-edit">
                ...
                <button type="button" class="btn btn-link p-0" data-item-action="resume-certification-delete"
                        data-id="{{ $args['id'] }}">
                        <span class="d-flex align-items-center justify-content-center">
            ...
            <p class="mb-0 text-grey">{{ $args['title'] }}
                {{--                <span class="text-secondary">{{ ucfirst($args['type']) }}</span>--}}
                <span class="text-secondary">{!! trans('fields.values.'.$args['type']) !!}</span>
                <span class="font-weight-bold">{{ $args['year'] }}</span>
            </p>
        </div>
    </div>
</div>