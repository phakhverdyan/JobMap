    ...
    <div class="text-left mb-3">
        <div class="d-flex">
            <div class="d-flex align-items-center ml-auto">
                <button type="button" class="btn btn-link p-0 mr-2" data-toggle="modal" data-target="#editModalLanguage" data-id="{{ $args['id'] }}" data-item-action="resume-language-edit">
                ...
                <button type="button" class="btn btn-link p-0" data-item-action="resume-language-delete"
                        data-id="{{ $args['id'] }}">
                        <span class="d-flex align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-between align-items-baseline">
            <p class="my-0 text-grey" style="flex: 1">{{ $args['title'] }}</p>
