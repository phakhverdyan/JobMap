<div class="input-group relative" style="width: auto;">
    <div class="input-group-btn" style=" border:1px solid rgba(78,92,110,.1); cursor: pointer;">
        <a href="javascript:void(0)" class="switcher_name profile-switcher btn btn-outline-success clear-mg btn-sm text-left px-1" title="View your business menu" style="border-radius: 5px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; color:#9BA6B2;">
            <i class="fa fa-refresh" aria-hidden="true" style="padding: 4px 5px;  margin-right: 15px;"></i>
            {!! trans('sidebar.text.switch_to_employer') !!}
        </a>
...
<div class="switcher_to_business business-list bg-white rounded border-top-right-0">
