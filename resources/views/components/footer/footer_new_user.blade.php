    <footer class="footer">
		<div class="container">
			<div class="text-center mb-5 d-lg-none d-block">
				<p class="mb-1"><img class="footer-logo align-self-center" src="{{ asset('img/C_logo_white.png') }}" style="width: 75px;"></p>
				<p class="footer-title footer-color text-center mb-0">CloudResume</p>
			</div>
			<div class="d-flex justify-content-between flex-lg-row flex-column mb-5 mb-lg-0">
				<div class="align-self-center col-12 col-lg-5">
					<div class="d-flex justify-content-between flex-sm-row flex-column text-center">
						...
						<a href="{!! url('/terms-of-service') !!}" class="footer-color flex-1" style="white-space: nowrap;">{!! trans('main.footer.general.terms_of_service') !!}</a>
					</div>
				</div>
				<div class="align-self-center col-12 col-lg-2 text-center d-lg-block d-none">
					<img class="footer-logo align-self-center" src="{{ asset('img/C_logo_white.png') }}" style="width: 75px;">
				</div>
				<div class="align-self-center col-12 col-lg-5">
					<div class="d-flex justify-content-between flex-sm-row flex-column text-center">
						<a href="{!! url('/faq') !!}"  class="footer-color flex-1">{!! trans('main.footer.general.general_faq') !!}</a>
						<a href="{!! url('/site_map') !!}"  class="footer-color flex-1">{!! trans('main.footer.general.site_map') !!}</a>
						<a href="javascript:;"  class="footer-color flex-1 user__signup">{!! trans('landing.nav.get_started') !!}</a>
					</div>
				</div>
				<!-- <ul class="mb-0 pl-0 d-flex bottom_section align-self-center flex-wrap pb-4 pb-lg-0 justify-content-center justify-content-lg-between w-100" style="list-style: none; line-height: 2;">
					...
					<li class="align-self-center pr-3 d-flex" style="color:#c4c4c4;">
						<img class="footer-logo align-self-center" src="{{ asset('img/C_logo_white.png') }}">{!! trans('main.footer.text') !!}
					</li>
			...
			<div class="d-flex justify-content-between flex-md-row flex-column mt-2 text-center">
				<div class="col-12 col-lg-4 col-md-6">
					...
					<ul class="pl-0 flex-wrap justify-content-md-center" style="list-style: none; line-height: 2;">
						<li class="footer-color"><a href="javascript:;" class="user__signup">{!! trans('main.footer.job_seekers.create_resume') !!}</a></li>
				...
				<div class="col-12 col-lg-4 d-lg-block d-none">
					<p class="footer-title footer-color text-center">CloudResume</p>
					...
					<p class="text-center footer-color mb-2" >{!! trans('main.footer.general.powered_with') !!}</p>
				...
				<div class="col-12 col-lg-4 col-md-6">
					...
					<ul class="pl-0 flex-wrap justify-content-md-center" style="list-style: none; line-height: 2;">
						<li class="footer-color"><a href="javascript:;" class="user__signup">{!! trans('main.footer.employers.create_account') !!}</a></li>
