<nav class="navbar navbar-light cr-navbar px-1 px-md-3" id="navbar" style="padding: 0 1rem; background-color: #fff;">
    <div class="d-flex justify-content-between col-12 px-0">
        <div class="align-self-center d-flex">
            ...
            <a href="javascript:;" class="cr-nav-text mx-2 align-self-center d-lg-none d-block show-sign-up"
            ...
            <a href="javascript:;" class="mx-3 align-self-center show-cv-widget d-lg-block d-none" style="margin-top:0!important;" data-toggle="tooltip" data-placement="bottom" title="{!! trans('main.navbar.create_my_JobMap') !!}">
                <strong>{!! trans('main.navbar.create_my_JobMap') !!}</strong>
            </a>
            <a href="{{ url('/landing') }}" class="cardinal_links align-self-center mx-2 d-md-flex d-none">{!! trans('main.navbar.hiring_add') !!}</a>
        </div>
        <div class="align-self-center d-flex">
                <p class="mb-0 px-1 align-self-center">
                    {!! trans('main.navbar.lang') !!}
                </p>
                <a class="align-self-center mr-md-3 mr-1 d-flex" href="{{ url('/') }}" style="padding: 5px 10px; font-size: 15px;">
                    {!! trans('main.navbar.explore_jobs_nav') !!}
                </a>
