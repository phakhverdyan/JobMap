...
<style>
    ...
    .qr-code-loading .fa.fa-circle-o-notch{
        position: absolute;
        top: 50%;
        left: 50%;
        z-index: 9999;
...
<div class="modal fade bd-example-modal-lg" id="QRCodeFirstStepModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <button id="QRCodeDefaultStepAction" type="button" class="btn btn-outline-primary"  style="width: 100%; font-size: 18px; min-height: 375px;">
                        ...
                        <div class="col-6">
                            <button id="QRCodeCustomStepAction" type="button" class="btn btn-outline-primary" style="width: 100%; font-size: 18px; min-height: 375px;">
...
<div class="modal fade bd-example-modal-lg" id="QRCodeDefaultStepModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 980px;">
        <div class="modal-content" style="overflow-y: auto; max-height: 850px;">
            <div class="qr-code-loading" style="display: none;">
                <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i>
            </div>
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">QRCode PDF</h5>
                <button type="button" class="btn btn-outline-primary button-back" style="position: absolute; right: 80px; top: 20px;">
                    Back
                </button>
                <button type="button" class="close" data-dismiss="modal"
                        aria-label="{!! trans('main.buttons.close') !!}">
...
<div class="modal fade bd-example-modal-lg" id="QRCodeCustomStepModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 980px;">
        <div class="modal-content ">
            <div class="qr-code-loading" style="display: none;">
                <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i>
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">QRCode Custom</h5>
                <button type="button" class="btn btn-outline-primary button-back" style="position: absolute; right: 80px; top: 20px;">
                    Back
                </button>
                <button type="button" class="close" data-dismiss="modal"
