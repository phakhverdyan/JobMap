		...
		<div class="modal-content">
			...
			<div class="modal-body pb-5">
				<div class="d-flex justify-content-between mb-3">
					<p>
						<strong>{!! trans('modals.text.share_location') !!}</strong>
					</p>
					<label class="switch">
				...
				<p>
					<strong>{!! trans('modals.text.share_location_via_email') !!}</strong>
				</p>
				<p>
				<div class="btn-group w-100" role="group" aria-label="Basic example">
					<input class="form-control border-top-right-0 border-bottom-right-0" type="text" name="sharelink" placeholder="{!! trans('fields.placeholder.email') !!}" id="ShareModal__email">
					<button class="btn btn-primary" id="ShareModal__send">{!! trans('main.buttons.send') !!}</button>
				</div>
				</p>
				<p class="mt-3">
		...
		<div class="modal-content">
			...
			<div class="modal-body pb-5">
				<div class="row pb-3 pt-1 px-3">
					<div class="col-lg-6 mx-auto col-12 pxa-0 pl-0">
