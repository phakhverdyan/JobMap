<div class="modal fade" id="addNewCandidate" tabindex="-1" role="dialog" aria-labelledby="signInModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0" style="position: relative;">
                <div class="col-12 text-center mt-3">
                    <form id="candidate_add-form" autocomplete="off" class="candidate__user-form">
                        <div class="row mb-3">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-3">
                            ...
                            <div class="col-12 col-lg-6 pr-0 pxa-0">
                                <label style="text-align: left;">{!! trans('fields.label.phone_number') !!}</label>
...
{{--                        {!!//trans('fields.placeholder.location') !!}--}}
                        ...
                        <p><label id="candidate_add-resume-attach_file-name"></label></p>
                        <p><a id="candidate_add-resume-delete-btn" style="display: none;">{!! trans('main.buttons.delete_resume') !!}</a></p>
                        <p><button type="button" id="candidate_add-resume-attach_file-btn" class="btn btn-outline-success btn-block">{!! trans('main.buttons.upload_resume') !!}</button></p>
                        <input type="file" name="attach_file" id="candidate_add-resume-attach_file-input" style="display: none" accept=".pdf, .jpg, .jpeg, .png">
                        <p>
                            <label for="candidate_add-select-pipeline" style="text-align: left;">Select Pipeline applied to</label>
                            <select name="pipeline_id" class="form-control" id="candidate_add-select-pipeline"></select>
                        </p>
                        <p>
                            <label for="candidate_add-select-job" style="text-align: left;">Select Job applied to</label>
                            <select name="job_id" class="form-control" id="candidate_add-select-job"></select>
                        </p>
                        <p>
                            <label for="candidate_add-select-location" style="text-align: left;">Select Location applied to</label>
                            <select name="location_id" class="form-control" id="candidate_add-select-location"></select>
                        </p>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="align-self-center col-lg-6">
                                <button type="button" id="candidate_add-btn-click" class="btn btn-primary px-5">{!! trans('main.buttons.add') !!}</button>
                            </div>
                        </div>
