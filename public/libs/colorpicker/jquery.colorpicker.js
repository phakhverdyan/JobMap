      ...
      alpha: function (inst) {
        var that = this,
          ...
          html = function () {
            ...
            if (inst.options.alpha) {
              html += '<div class="ui-colorpicker-a"><label style="display: block;">' + inst._getRegional('alphaA') + '</label><input class="ui-colorpicker-mode" name="mode" type="radio" value="a"/><input class="ui-colorpicker-number" type="number" min="0" max="100"/><span class="ui-colorpicker-unit">%</span></div>';
            }
      ...
      footer: function (inst) {
        var that = this,
          ...
          html = function () {
            ...
            if (inst.options.showTransparentButton && (inst.options.alpha || (!inst.inline && inst.options.showNoneButton))) {
