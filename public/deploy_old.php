...
class Deploy {
  ...
  * @var string
  */
  private $_log = '/var/www/cloudresume/logs/deploy.log';
  /**
  ...
  */
  public function execute()
  {
	  ...
	  exec('git pull git@bitbucket.org:bogdantarasenkozp/cloudresume-laravel.git');
...
*/
	$slug = [
	   ...
	   'branch' => 'bogdantarasenkozp/cloudresume-laravel.git',
	];
        $deploy = new Deploy($root_dir . $repos[$slug]);
        $deploy->execute();
