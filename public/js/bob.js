  ...
  BFHSelectBox.prototype = {
    ...
    initSelectBox: function () {
      ...
      this.$element.html(
		...
		'<a class="bfh-selectbox-toggle input_style text-left   ' + this.options.input + '" role="button" data-toggle="bfh-selectbox" href="#" style="padding: 8px 20px;">' +
		'<span class="bfh-selectbox-option"></span>' +
		'</a>' +
		'<div class="bfh-selectbox-options text-left">' +
		'<div role="listbox">' +
		'<ul role="option">' +
		'</ul>' +
		'</div>' +
      ...
      if (this.options.filter === true) {
        this.$element.find('.bfh-selectbox-options').prepend('<div class="bfh-selectbox-filter-container"><input type="text" class="bfh-selectbox-filter form-control" placeholder="Type country name or code number"></div>');
      }
