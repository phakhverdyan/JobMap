    ...
    _createClass(SideNav, [{
      ...
      value: function buildSidenavOverlay() {
        ...
        if (this.options.showOverlay === true) {
          ...
          this.$body.find("#sidenav-overlay").remove();
        ...
        this.$element.on('click', function (e) {
          ...
          if (_this3.menuOut === true) {
            ...
            if (_this3.options.showOverlay === true) {
              ...
              _this3.$body.find("#sidenav-overlay").remove();
        ...
        if (!this.$menu.hasClass('fixed')) {
          ...
          $(window).resize(function () {
            ...
            if (window.innerWidth > _this5.options.breakpoint) {
              console.log(_this5.options.breakpoint);
...
$(function () {
  ...
  $(window).resize(function (event) {
    $(document).find("body").removeClass('slim-menu');
  });

  $(document).find("#toggle-menu").on("click", function (event) {
    event.preventDefault();
    if ($(document).find("body").hasClass('slim-menu')) {
      $(document).find("body").removeClass('slim-menu');
      //$(document).find(".nav-side-menu").css({"width": "320px"});
    } else {
      ///close status
      $(document).find("body").addClass('slim-menu');
      //$(document).find(".nav-side-menu").css({"width": "70px"});
    }
  });
